...
public final class e0 extends p {
    ...
    public final FileChannel f81891g;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e0(boolean z10, FileChannel fileChannel) {
        super(z10);
        kotlin.jvm.internal.e0.checkNotNullParameter(fileChannel, "fileChannel");
        this.f81891g = fileChannel;
    }
    ...
    public final synchronized int i(long j10, byte[] array, int i10, int i11) {
        ...
        while (true) {
            ...
            int i13 = this.f81891g.read(byteBufferWrap);
            if (i13 != -1) {
                i12 += i13;
            } else if (i12 == 0) {
                return -1;
    ...
    public final synchronized void l(long j10, byte[] array, int i10, int i11) {
        kotlin.jvm.internal.e0.checkNotNullParameter(array, "array");
        this.f81891g.position(j10);
        this.f81891g.write(ByteBuffer.wrap(array, i10, i11));
    }
}
