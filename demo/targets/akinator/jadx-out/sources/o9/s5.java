...
public final class s5 extends bv.n implements kv.p {

    /* renamed from: i, reason: collision with root package name */
    public int f78530i;

    /* renamed from: j, reason: collision with root package name */
    public final /* synthetic */ QuestionActivity f78531j;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public s5(QuestionActivity questionActivity, zu.d dVar) {
        super(2, dVar);
        this.f78531j = questionActivity;
    }

    @Override // bv.a
    public final zu.d<tu.x0> create(Object obj, zu.d<?> dVar) {
        return new s5(this.f78531j, dVar);
    }

    @Override // bv.a
    public final Object invokeSuspend(Object obj) {
        Object coroutine_suspended = av.e.getCOROUTINE_SUSPENDED();
        int i10 = this.f78530i;
        oa.l lVar = null;
        QuestionActivity questionActivity = this.f78531j;
        if (i10 == 0) {
    ...
    public final Object invoke(CoroutineScope coroutineScope, zu.d<? super tu.x0> dVar) {
        return ((s5) create(coroutineScope, dVar)).invokeSuspend(tu.x0.f87415a);
    }
}
