...
public final class d4 implements Animation.AnimationListener {
    ...
    public final /* synthetic */ OneCharacterProposalActivity f78090c;

    public d4(OneCharacterProposalActivity oneCharacterProposalActivity, String str) {
        this.f78090c = oneCharacterProposalActivity;
        this.f78089b = str;
    }

    @Override // android.view.animation.Animation.AnimationListener
    public void onAnimationEnd(Animation animation) {
        OneCharacterProposalActivity oneCharacterProposalActivity = this.f78090c;
        Intent intent = new Intent(oneCharacterProposalActivity, (Class<?>) DefiDuJourActivity.class);
        intent.putExtra("keyPersoTrouve", this.f78089b);
