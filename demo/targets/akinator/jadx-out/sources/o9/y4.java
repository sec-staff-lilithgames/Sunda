...
public final class y4 implements da.g {

    /* renamed from: a, reason: collision with root package name */
    public final /* synthetic */ PostProposeActivity f78688a;

    public y4(PostProposeActivity postProposeActivity) {
        this.f78688a = postProposeActivity;
    }

    @Override // da.g
    public void onCloseConfirme() {
        boolean zIsUserConnected = ca.m.sharedInstance().isUserConnected();
        PostProposeActivity postProposeActivity = this.f78688a;
        if (zIsUserConnected) {
        ...
        ca.m.sharedInstance().setIsComingFromPopupClassement(true);
    ...
    public void onClosedRefuse() {
        ca.m.sharedInstance().changeClassementState(1);
