...
public final class v5 implements Animation.AnimationListener {

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ QuestionActivity f78629b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ String f78630c;

    public v5(QuestionActivity questionActivity, String str) {
        this.f78629b = questionActivity;
        this.f78630c = str;
    }
    ...
    public void onAnimationEnd(Animation animation) {
        ...
        QuestionActivity questionActivity = this.f78629b;
        Intent intent = new Intent(questionActivity, (Class<?>) DefiDuJourActivity.class);
        intent.putExtra("keyPersoTrouve", this.f78630c);
