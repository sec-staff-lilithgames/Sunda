...
public final class a implements ko.z {

    /* renamed from: a, reason: collision with root package name */
    public final b f84526a = new b(MimeTypes.AUDIO_AC3);

    /* renamed from: b, reason: collision with root package name */
    public final io.bidmachine.media3.common.util.m0 f84527b = new io.bidmachine.media3.common.util.m0(2786);
    ...
    public void init(ko.c0 c0Var) {
        this.f84526a.createTracks(c0Var, new m0(0, 1));
        c0Var.endTracks();
    ...
    public int read(ko.a0 a0Var, v0 v0Var) throws IOException {
        io.bidmachine.media3.common.util.m0 m0Var = this.f84527b;
        int i10 = a0Var.read(m0Var.getData(), 0, 2786);
        if (i10 == -1) {
            return -1;
        }
        m0Var.setPosition(0);
        m0Var.setLimit(i10);
        boolean z10 = this.f84528c;
        b bVar = this.f84526a;
        if (!z10) {
    ...
    public boolean sniff(ko.a0 a0Var) throws IOException {
        ...
        while (true) {
            ...
            if (m0Var.readUnsignedShort() != 2935) {
                ...
                int ac3SyncframeSize = ko.d.parseAc3SyncframeSize(m0Var.getData());
                if (ac3SyncframeSize == -1) {
                    return false;
                }
                a0Var.advancePeekPosition(ac3SyncframeSize - 6);
            }
        }
    }
