...
final class Utils {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return o2.o(new StringBuilder(), Utils.typeToString(this.componentType), HttpUrl.PATH_SEGMENT_ENCODE_SET_URI);
        }
    }
    ...
    public static w0 buffer(w0 w0Var) throws IOException {
        g gVar = new g();
    ...
    public static Type getParameterUpperBound(int i10, ParameterizedType parameterizedType) {
        ...
        StringBuilder sbT = p0.o2.t(i10, "Index ", " not in range [0,");
    ...
    public static boolean isUnit(Type type) {
        return checkForKotlinUnit && type == x0.class;
    }
    ...
    public static RuntimeException parameterError(Method method, Throwable th2, int i10, String str, Object... objArr) {
        return methodError(method, th2, e3.g.k(str, " (", Platform.reflection.describeMethodParameter(method, i10), ")"), objArr);
    }
    ...
    public static RuntimeException methodError(Method method, Throwable th2, String str, Object... objArr) {
        StringBuilder sbT = b.t(String.format(str, objArr), "\n    for method ");
    ...
    public static RuntimeException parameterError(Method method, int i10, String str, Object... objArr) {
        return methodError(method, e3.g.k(str, " (", Platform.reflection.describeMethodParameter(method, i10), ")"), objArr);
    }
}
