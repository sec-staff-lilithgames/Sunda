...
public final class i1 implements i.b {

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ FragmentManager f6383b;

    public i1(FragmentManager fragmentManager) {
        this.f6383b = fragmentManager;
    }

    @Override // i.b
    public void onActivityResult(ActivityResult activityResult) {
        FragmentManager fragmentManager = this.f6383b;
