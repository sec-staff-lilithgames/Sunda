...
public class FileProvider extends ContentProvider {
    ...
    public static XmlResourceParser getFileProviderPathsMetaData(Context context, String str, ProviderInfo providerInfo, int i10) {
        if (providerInfo == null) {
            throw new IllegalArgumentException(a.b.k("Couldn't find meta-data for provider with authority ", str));
        }
    ...
    private b getLocalPathStrategy() {
        ...
        synchronized (this.mLock) {
            try {
                d.requireNonNull(this.mAuthority, "mAuthority is null. Did you override attachInfo and did not call super.attachInfo()?");
    ...
    public static Uri getUriForFile(Context context, String str, File file) {
        return ((c) getPathStrategy(context, str, 0)).getUriForFile(file);
    }
    ...
    private static int modeToMode(String str) {
        ...
        throw new IllegalArgumentException(a.b.k("Invalid mode: ", str));
    }
        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                if (externalStorageDirectory != null) {
                    ...
                    try {
                        cVar.f74003b.put(attributeValue, fileBuildPath.getCanonicalFile());
                    } catch (IOException e10) {
                        throw new IllegalArgumentException(o2.h(fileBuildPath, "Failed to resolve canonical path for "), e10);
                    }
                } else {
                    continue;
                }
    ...
    public int delete(Uri uri, String str, String[] strArr) {
        return ((c) getLocalPathStrategy()).getFileForUri(uri).delete() ? 1 : 0;
    }

    @Override // android.content.ContentProvider
    public String getType(Uri uri) {
        File fileForUri = ((c) getLocalPathStrategy()).getFileForUri(uri);
    ...
    public ParcelFileDescriptor openFile(Uri uri, String str) throws FileNotFoundException {
        return ParcelFileDescriptor.open(((c) getLocalPathStrategy()).getFileForUri(uri), modeToMode(str));
    }
