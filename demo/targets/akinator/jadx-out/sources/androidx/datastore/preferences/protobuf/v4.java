...
public interface v4 {
    ...
    void writeBytes(int i10, x xVar) throws IOException;

    void writeBytesList(int i10, List<x> list) throws IOException;
    ...
    @Deprecated
    void writeGroup(int i10, Object obj, m3 m3Var) throws IOException;

    @Deprecated
    void writeGroupList(int i10, List<?> list) throws IOException;

    @Deprecated
    void writeGroupList(int i10, List<?> list, m3 m3Var) throws IOException;
    ...
    <K, V> void writeMap(int i10, i2 i2Var, Map<K, V> map) throws IOException;

    void writeMessage(int i10, Object obj) throws IOException;

    void writeMessage(int i10, Object obj, m3 m3Var) throws IOException;

    void writeMessageList(int i10, List<?> list) throws IOException;

    void writeMessageList(int i10, List<?> list, m3 m3Var) throws IOException;
