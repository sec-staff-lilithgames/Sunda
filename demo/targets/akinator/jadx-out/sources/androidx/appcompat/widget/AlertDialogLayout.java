...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    public static int a(View view) {
        int minimumHeight = z1.getMinimumHeight(view);
        if (minimumHeight > 0) {
    ...
    */
    public final void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        L73:
            ...
            int r7 = x3.u.getAbsoluteGravity(r7, r8)
            r7 = r7 & 7
            r8 = 1
            if (r7 == r8) goto L8d
            r8 = 5
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (view2 != null) {
            int i14 = paddingBottom - iA;
            int iMin = Math.min(i13, measuredHeight);
            if (iMin > 0) {
                i13 -= iMin;
                iA += iMin;
            }
            view2.measure(i10, View.MeasureSpec.makeMeasureSpec(iA, 1073741824));
