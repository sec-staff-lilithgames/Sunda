...
public final class d0 extends d {
    ...
    public final transient j$.time.h f68473a;
    ...
    public final int hashCode() {
        b0.f68470c.getClass();
        return this.f68473a.hashCode() ^ (-1990173233);
    }
    ...
    public final j$.time.temporal.t i(j$.time.temporal.p pVar) {
        ...
        int i10 = c0.f68472a[aVar.ordinal()];
        if (i10 == 1 || i10 == 2 || i10 == 3) {
            return this.f68473a.i(pVar);
        }
        if (i10 != 4) {
            return b0.f68470c.t(aVar);
        }
        j$.time.temporal.t tVar = j$.time.temporal.a.YEAR.f68639b;
        return j$.time.temporal.t.e(1L, J() <= 0 ? (-tVar.f68663a) + 1912 : tVar.f68666d - 1911);
    }

    @Override // j$.time.temporal.m
    public final long f(j$.time.temporal.p pVar) {
        if (pVar instanceof j$.time.temporal.a) {
            int i10 = c0.f68472a[((j$.time.temporal.a) pVar).ordinal()];
            if (i10 == 4) {
                int iJ = J();
                if (iJ < 1) {
                    iJ = 1 - iJ;
            ...
            if (i10 == 5) {
                return ((J() * 12) + this.f68473a.f68602b) - 1;
            }
            if (i10 == 6) {
                return J();
            }
            if (i10 != 7) {
                return this.f68473a.f(pVar);
            }
            return J() < 1 ? 0 : 1;
        }
        return pVar.D(this);
    ...
    public final int J() {
        return this.f68473a.f68601a - 1911;
    }
    ...
    */
    public final j$.time.chrono.d0 g(long r8, j$.time.temporal.p r10) {
        /*
            r7 = this;
            ...
            return r7
        L10:
            int[] r1 = j$.time.chrono.c0.f68472a
            int r2 = r0.ordinal()
            r2 = r1[r2]
            r3 = 7
            r4 = 6
            ...
            goto L5f
        L25:
            j$.time.chrono.b0 r10 = j$.time.chrono.b0.f68470c
            ...
            return r8
        L49:
            j$.time.chrono.b0 r2 = j$.time.chrono.b0.f68470c
            ...
            if (r0 == r3) goto L6a
        L5f:
            j$.time.h r0 = r7.f68473a
            j$.time.h r8 = r0.g(r8, r10)
            j$.time.chrono.d0 r8 = r7.L(r8)
            return r8
        L6a:
            j$.time.h r8 = r7.f68473a
            int r9 = r7.J()
            int r9 = 1912 - r9
            j$.time.h r8 = r8.W(r9)
            j$.time.chrono.d0 r8 = r7.L(r8)
        ...
        L9f:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: j$.time.chrono.d0.g(long, j$.time.temporal.p):j$.time.chrono.d0");
    }

    @Override // j$.time.chrono.d
    /* renamed from: I */
    public final b w(j$.time.temporal.n nVar) {
        return (d0) super.w(nVar);
    }

    @Override // j$.time.chrono.d, j$.time.temporal.l
    /* renamed from: h */
    public final j$.time.temporal.l w(j$.time.h hVar) {
        return (d0) super.w(hVar);
    }

    @Override // j$.time.chrono.d
    public final b G(long j10) {
        return L(this.f68473a.R(j10));
    }

    @Override // j$.time.chrono.d
    public final b D(long j10) {
        return L(this.f68473a.Q(j10));
    }

    @Override // j$.time.chrono.d
    public final b t(long j10) {
        return L(this.f68473a.P(j10));
    }

    @Override // j$.time.chrono.d, j$.time.chrono.b, j$.time.temporal.l
    public final b j(long j10, j$.time.temporal.r rVar) {
        return (d0) super.j(j10, rVar);
    }
    ...
    public final d0 L(j$.time.h hVar) {
        return hVar.equals(this.f68473a) ? this : new d0(hVar);
    }

    @Override // j$.time.chrono.b
    public final long z() {
        return this.f68473a.z();
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof d0) {
            return this.f68473a.equals(((d0) obj).f68473a);
        }
        return false;
    }
