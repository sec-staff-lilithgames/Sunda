...
public final class a implements Externalizable {
    ...
    public final void writeExternal(ObjectOutput objectOutput) throws IOException {
        byte b10 = this.f68698a;
        Object obj = this.f68699b;
        objectOutput.writeByte(b10);
        if (b10 != 1) {
            if (b10 == 2) {
                b bVar = (b) obj;
                c(bVar.f68701a, objectOutput);
                d(bVar.f68703c, objectOutput);
                d(bVar.f68704d, objectOutput);
                return;
            }
            if (b10 == 3) {
                ...
                objectOutput.writeUTF(((f) obj).f68726g.getID());
                return;
            }
        }
        f fVar = (f) obj;
        objectOutput.writeInt(fVar.f68720a.length);
        for (long j10 : fVar.f68720a) {
            c(j10, objectOutput);
        }
        for (ZoneOffset zoneOffset : fVar.f68721b) {
            d(zoneOffset, objectOutput);
        }
        objectOutput.writeInt(fVar.f68722c.length);
        for (long j11 : fVar.f68722c) {
            c(j11, objectOutput);
        }
        for (ZoneOffset zoneOffset2 : fVar.f68724e) {
            d(zoneOffset2, objectOutput);
        }
        objectOutput.writeByte(fVar.f68725f.length);
        for (e eVar : fVar.f68725f) {
            eVar.b(objectOutput);
        }
    }
    ...
    public final void readExternal(ObjectInput objectInput) throws IOException {
        ...
        if (b10 == 1) {
            ...
            e[] eVarArr = i18 == 0 ? f.f68717j : new e[i18];
    ...
    public static ZoneOffset b(DataInput dataInput) throws IOException {
        ...
        return b10 == 127 ? ZoneOffset.L(dataInput.readInt()) : ZoneOffset.L(b10 * 900);
    }
    ...
    public static long a(DataInput dataInput) {
        if ((dataInput.readByte() & AdConfig.NETWORK_LOAD_LIMIT_DISABLED) == 255) {
            return dataInput.readLong();
        }
        return ((((r0 << 16) + ((dataInput.readByte() & AdConfig.NETWORK_LOAD_LIMIT_DISABLED) << 8)) + (dataInput.readByte() & AdConfig.NETWORK_LOAD_LIMIT_DISABLED)) * 900) - 4575744000L;
    }

    public static void d(ZoneOffset zoneOffset, DataOutput dataOutput) throws IOException {
        int i10 = zoneOffset.f68463b;
