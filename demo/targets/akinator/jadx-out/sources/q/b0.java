...
public class b0 extends MultiAutoCompleteTextView implements x3.e1, t1, e4.x {

    /* renamed from: f, reason: collision with root package name */
    public static final int[] f82038f = {R.attr.popupBackground};

    /* renamed from: b, reason: collision with root package name */
    public final s f82039b;

    /* renamed from: c, reason: collision with root package name */
    public final v0 f82040c;

    /* renamed from: e, reason: collision with root package name */
    public final e0 f82041e;
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f82040c.d();
    }

    @Override // e4.x
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f82040c.e();
    }

    @Override // q.t1
    public boolean isEmojiCompatEnabled() {
        return ((u4.a) this.f82041e.f82065c).isEnabled();
    }
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        return ((u4.a) this.f82041e.f82065c).onCreateInputConnection(inputConnectionOnCreateInputConnection, editorInfo);
    }
    ...
    public void setEmojiCompatEnabled(boolean z10) {
        ((u4.a) this.f82041e.f82065c).setEnabled(z10);
    }

    @Override // android.widget.TextView
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f82041e.a(keyListener));
    }
    ...
    public b0(Context context, AttributeSet attributeSet, int i10) {
        ...
        n3 n3VarObtainStyledAttributes = n3.obtainStyledAttributes(getContext(), attributeSet, f82038f, i10, 0);
