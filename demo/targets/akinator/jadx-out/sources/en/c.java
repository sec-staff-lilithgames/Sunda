...
public class c extends FullScreenAdRequestParameters {
    ...
    public c(AdContentType adContentType) {
        int i10 = b.f54791a[adContentType.ordinal()];
        super(new AdPlacementConfig.Builder(i10 != 1 ? i10 != 2 ? AdsFormat.Interstitial : AdsFormat.InterstitialVideo : AdsFormat.InterstitialStatic).build(), adContentType);
    }

    @Override // io.bidmachine.AdRequestParameters
    public boolean isPlacementObjectValid(Placement placement) throws Throwable {
        return i.isInterstitialPlacement(placement);
    }
}
