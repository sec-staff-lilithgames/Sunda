...
public abstract class rc {
    ...
    public final Unsafe f22563a;

    public rc(Unsafe unsafe) {
        this.f22563a = unsafe;
    }

    public final int arrayBaseOffset(Class<?> cls) {
        return this.f22563a.arrayBaseOffset(cls);
    }

    public final int arrayIndexScale(Class<?> cls) {
        return this.f22563a.arrayIndexScale(cls);
    }
