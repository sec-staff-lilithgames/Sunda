...
public enum Field$Kind implements ja {
    TYPE_UNKNOWN(0),
    TYPE_DOUBLE(1),
    TYPE_FLOAT(2),
    TYPE_INT64(3),
    ...
    private static final p7 internalValueMap = new u5();
    ...
    public static final Descriptors.EnumDescriptor getDescriptor() {
        return v5.getDescriptor().getEnumTypes().get(0);
    }
    ...
    public static Field$Kind valueOf(Descriptors.EnumValueDescriptor enumValueDescriptor) {
