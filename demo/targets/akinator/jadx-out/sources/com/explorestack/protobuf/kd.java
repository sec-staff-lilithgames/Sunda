...
public interface kd {
    ...
    @Deprecated
    void writeGroup(int i10, Object obj, ua uaVar) throws IOException;

    @Deprecated
    void writeGroupList(int i10, List<?> list) throws IOException;

    @Deprecated
    void writeGroupList(int i10, List<?> list, ua uaVar) throws IOException;
    ...
    <K, V> void writeMap(int i10, t8 t8Var, Map<K, V> map) throws IOException;

    void writeMessage(int i10, Object obj) throws IOException;

    void writeMessage(int i10, Object obj, ua uaVar) throws IOException;

    void writeMessageList(int i10, List<?> list) throws IOException;

    void writeMessageList(int i10, List<?> list, ua uaVar) throws IOException;
