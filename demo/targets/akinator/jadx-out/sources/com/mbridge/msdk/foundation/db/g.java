...
public class g extends f {
    ...
    public static synchronized g a(Context context) {
        try {
            if (f40470b == null) {
                f40470b = new g(context.getApplicationContext());
            }
        } catch (Throwable th2) {
            throw th2;
        }
    ...
    @Override // com.mbridge.msdk.foundation.db.f
    public void b(SQLiteDatabase sQLiteDatabase, int i10, int i11) throws SQLException {
    ...
    @Override // com.mbridge.msdk.foundation.db.f
    public void a(SQLiteDatabase sQLiteDatabase, int i10, int i11) throws SQLException {
        if (com.mbridge.msdk.util.d.a(sQLiteDatabase)) {
            c(sQLiteDatabase);
            b(sQLiteDatabase);
        }
