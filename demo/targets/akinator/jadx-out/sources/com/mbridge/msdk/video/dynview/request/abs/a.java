...
public abstract class a extends c<JSONObject> {
    ...
    private void a(List<g> list, JSONObject jSONObject) {
        ...
        CampaignUnit v5CampaignUnit = "v5".equals(jSONObject.optString("version")) ? b.parseV5CampaignUnit(jSONObject.optJSONObject("data"), this.f44455b) : b.parseCampaignUnit(jSONObject.optJSONObject("data"), this.f44455b);
    ...
    public void onSuccess(e<JSONObject> eVar) {
        ...
        if (eVar == null || (aVar = eVar.f40802b) == null || this.f44454a != 0) {
            return;
        }
