...
public class a {
    ...
    public class C0320a extends com.mbridge.msdk.foundation.same.net.handler.a {
        ...
        public void a(String str) {
            com.google.android.gms.internal.play_billing.a.D("fail request mraid js. ", str, "MraidJSController");
        }
    ...
    public class b implements Runnable {
        ...
        public void run() throws Throwable {
            try {
                ...
                n0.a(this.f42728a.getBytes(), file);
                com.mbridge.msdk.foundation.buffer.sharedperference.a.b().a("MraidJSController", this.f42729b);
            } catch (Exception e10) {
    ...
    private String c() {
        try {
            File file = new File(e.b(c.MBRIDGE_OTHER), "mraid_js.txt");
            return (file.exists() && file.canRead()) ? n0.e(file) : "";
        } catch (Exception e10) {
            p0.a("MraidJSController", e10.getMessage());
            return "";
        }
    ...
    public String b() {
        try {
            if (TextUtils.isEmpty(this.f42725a)) {
                this.f42725a = c();
            }
            if (!TextUtils.isEmpty(this.f42725a)) {
                return this.f42725a;
    ...
    public void a(Context context, String str) {
        ...
        if (TextUtils.isEmpty(strA) || !strA.equals(str)) {
            try {
                new com.mbridge.msdk.setting.net.a(context).get(0, str, (com.mbridge.msdk.foundation.same.net.wrapper.e) null, new C0320a(str), "mraid_js", ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS);
            } catch (Exception e10) {
