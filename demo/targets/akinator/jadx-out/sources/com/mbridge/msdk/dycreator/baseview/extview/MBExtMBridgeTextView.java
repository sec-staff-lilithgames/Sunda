...
public class MBExtMBridgeTextView extends MBridgeTextView implements InterBase {
    ...
    private Map<String, String> f40047b;

    /* renamed from: c, reason: collision with root package name */
    private Map<String, Boolean> f40048c;
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f40050a[c.text.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f40050a[c.ellipsize.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f40050a[c.singleLine.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f40050a[c.lines.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f40050a[c.drawableLeft.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f40050a[c.drawablePadding.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f40050a[c.fadingEdge.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f40050a[c.scrollHorizontally.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f40050a[c.textColor.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f40050a[c.textSize.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f40050a[c.visibility.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f40050a[c.background.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f40050a[c.textStyle.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f40050a[c.style.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f40050a[c.contentDescription.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f40050a[c.tag.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f40050a[c.gravity.ordinal()] = 18;
            } catch (NoSuchFieldError unused18) {
            }
            try {
                f40050a[c.padding.ordinal()] = 19;
            } catch (NoSuchFieldError unused19) {
            }
            try {
                f40050a[c.paddingTop.ordinal()] = 20;
            } catch (NoSuchFieldError unused20) {
            }
            try {
                f40050a[c.paddingBottom.ordinal()] = 21;
            } catch (NoSuchFieldError unused21) {
            }
            try {
                f40050a[c.paddingLeft.ordinal()] = 22;
            } catch (NoSuchFieldError unused22) {
            }
            try {
                f40050a[c.paddingRight.ordinal()] = 23;
            } catch (NoSuchFieldError unused23) {
            }
            try {
                f40050a[c.paddingStart.ordinal()] = 24;
            } catch (NoSuchFieldError unused24) {
            }
            try {
                f40050a[c.paddingEnd.ordinal()] = 25;
            } catch (NoSuchFieldError unused25) {
            }
            try {
                f40050a[c.maxLength.ordinal()] = 26;
            } catch (NoSuchFieldError unused26) {
            }
            try {
                f40050a[c.layout_width.ordinal()] = 27;
            } catch (NoSuchFieldError unused27) {
            }
            try {
                f40050a[c.layout_height.ordinal()] = 28;
    ...
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i10 = 0; i10 < attributeCount; i10++) {
            ...
            if (cVar != null) {
                int i11 = AnonymousClass1.f40050a[cVar.ordinal()];
                if (i11 == 27) {
    ...
    public String getActionDes() {
        Map<String, String> map = this.f40047b;
        return (map == null || !map.containsKey("mbridgeAction")) ? "" : this.f40047b.get("mbridgeAction");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getBindDataDes() {
        Map<String, String> map = this.f40047b;
        return (map == null || !map.containsKey("mbridgeData")) ? "" : this.f40047b.get("mbridgeData");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getEffectDes() {
        Map<String, String> map = this.f40047b;
        return (map == null || !map.containsKey("mbridgeEffect")) ? "" : this.f40047b.get("mbridgeEffect");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getReportDes() {
        Map<String, String> map = this.f40047b;
        return (map == null || !map.containsKey("mbridgeReport")) ? "" : this.f40047b.get("mbridgeReport");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getStrategyDes() {
        Map<String, String> map = this.f40047b;
        return (map == null || !map.containsKey("mbridgeStrategy")) ? "" : this.f40047b.get("mbridgeStrategy");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.cusview.MBridgeTextView, android.widget.TextView, android.view.View
    public void onAttachedToWindow() {
        super.onAttachedToWindow();
        Map<String, Boolean> map = this.f40048c;
        if (map != null && map.containsKey("mbridgeAttached") && this.f40048c.get("mbridgeAttached").booleanValue()) {
            a.e("mbridgeAttached").b(this.f40049d);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f40048c;
        if (map != null && map.containsKey("mbridgeDetached") && this.f40048c.get("mbridgeDetached").booleanValue()) {
            a.e("mbridgeDetached").b(this.f40049d);
        }
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f40048c = com.mbridge.msdk.dycreator.utils.c.a(str);
        if (campaignEx != null) {
            this.f40049d = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) throws Resources.NotFoundException, NumberFormatException {
        ...
        for (int i10 = 0; i10 < attributeCount; i10++) {
            ...
            if (cVar != null) {
                ...
                switch (AnonymousClass1.f40050a[cVar.ordinal()]) {
                    case 1:
                        String attributeValue = attributeSet.getAttributeValue(i10);
                    ...
                    case 6:
                        ...
                        String strSubstring = attributeValue4.startsWith("@drawable/") ? attributeValue4.substring(10) : PcrIk.xqKf;
    ...
    public MBExtMBridgeTextView(Context context, AttributeSet attributeSet) {
        ...
        this.f40049d = "";
        try {
            this.f40047b = com.mbridge.msdk.dycreator.utils.c.a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            com.mbridge.msdk.dycreator.utils.c.a(this.f40047b, this);
        } catch (Exception e10) {
