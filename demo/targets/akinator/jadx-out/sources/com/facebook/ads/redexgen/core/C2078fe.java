...
public class C2078fe extends PH {
    public int A00;

    public C2078fe(Context context) {
        super(context);
        this.A00 = 0;
    }
    ...
    */
    public final void onMeasure(int r5, int r6) throws android.content.res.Resources.NotFoundException {
        ...
        L1f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2078fe.onMeasure(int, int):void");
    }
}
