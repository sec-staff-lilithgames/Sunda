...
public class C2436lv<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public int A07(@CheckForNull Object key) {
        ...
        int iA02 = AbstractC2470mU.A02(key);
        int iA00 = A00();
        int iA05 = AbstractC2439ly.A05(A0C(), iA02 & iA00);
        if (iA05 == 0) {
            return -1;
        }
        int iA022 = AbstractC2439ly.A02(iA02, iA00);
        do {
            int i10 = iA05 - 1;
            int iA01 = A01(i10);
            if (AbstractC2439ly.A02(iA01, iA00) == iA022 && BX.A01(key, A0E(i10))) {
                return i10;
            }
            iA05 = AbstractC2439ly.A03(iA01, iA00);
        } while (iA05 != 0);
        return -1;
    }
    ...
    public void A0n(int dstIndex, int mask) {
        ...
        iArrA0T[size] = 0;
        int iA02 = AbstractC2470mU.A02(obj) & mask;
        int iA05 = AbstractC2439ly.A05(objA0C, iA02);
        int i12 = size + 1;
        if (iA05 == i12) {
            AbstractC2439ly.A0B(objA0C, iA02, dstIndex + 1);
            return;
        }
        do {
            i10 = iA05 - 1;
            i11 = iArrA0T[i10];
            iA05 = AbstractC2439ly.A03(i11, mask);
        } while (iA05 != i12);
        int iA04 = AbstractC2439ly.A04(i11, dstIndex + 1, mask);
    ...
    public final V put(@ParametricNullness K k10, @ParametricNullness V v10) {
        ...
        int i12 = this.A04;
        int i13 = i12 + 1;
        int iA02 = AbstractC2470mU.A02(k10);
        int iA00 = A00();
        int i14 = iA02 & iA00;
        int iA05 = AbstractC2439ly.A05(A0C(), i14);
        if (iA05 != 0) {
            int iA022 = AbstractC2439ly.A02(iA02, iA00);
            int i15 = 0;
            do {
                i10 = iA05 - 1;
                i11 = iArrA0T[i10];
                if (AbstractC2439ly.A02(i11, iA00) == iA022 && BX.A01(k10, objArrA0V[i10])) {
                    V v11 = (V) objArrA0W[i10];
                    objArrA0W[i10] = v10;
                    A0k(i10);
                    return v11;
                }
                iA05 = AbstractC2439ly.A03(i11, iA00);
                i15++;
            } while (iA05 != 0);
            if (i15 >= 9) {
            ...
            if (i13 > iA00) {
                iA00 = A02(iA00, AbstractC2439ly.A00(iA00), iA02, i12);
            } else {
                iArrA0T[i10] = AbstractC2439ly.A04(i11, i12 + 1, iA00);
            }
        } else {
            if (i13 <= iA00) {
                AbstractC2439ly.A0B(A0C(), i14, i12 + 1);
                String[] strArr = A0A;
                if (strArr[0].length() != strArr[1].length()) {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.lv != com.google.common.collect.CompactHashMap<K, V> */
    public C2436lv(int expectedSize) {
        A0l(expectedSize);
    }
    ...
    private int A02(int oldMask, int newCapacity, int targetHash, int targetEntryIndex) {
        Object objA07 = AbstractC2439ly.A07(newCapacity);
        int hash = newCapacity - 1;
        if (targetEntryIndex != 0) {
            AbstractC2439ly.A0B(objA07, targetHash & hash, targetEntryIndex + 1);
        }
        Object objA0C = A0C();
        int[] iArrA0T = A0T();
        for (int oldTableIndex = 0; oldTableIndex <= oldMask; oldTableIndex++) {
            int iA05 = AbstractC2439ly.A05(objA0C, oldTableIndex);
            while (iA05 != 0) {
                int i10 = iA05 - 1;
                int newMask = iArrA0T[i10];
                int iA02 = AbstractC2439ly.A02(newMask, oldMask) | oldTableIndex;
                int i11 = iA02 & hash;
                int iA052 = AbstractC2439ly.A05(objA07, i11);
                AbstractC2439ly.A0B(objA07, i11, iA05);
                iArrA0T[i10] = AbstractC2439ly.A04(iA02, iA052, hash);
                iA05 = AbstractC2439ly.A03(newMask, oldMask);
            }
        }
        this.A05 = objA07;
        A0O(hash);
    ...
    public static /* synthetic */ int A04(C2436lv c2436lv) {
        int i10 = c2436lv.A04;
        c2436lv.A04 = i10 - 1;
        return i10;
    }
    ...
    private final Set<Map.Entry<K, V>> A08() {
        return new C2432lr(this);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.lv != com.google.common.collect.CompactHashMap<K, V> */
    private final Set<K> A09() {
        return new C2434lt(this);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.lv != com.google.common.collect.CompactHashMap<K, V> */
    private final Collection<V> A0A() {
        return new C2435lu(this);
    }

    public static <K, V> C2436lv<K, V> A0B(int expectedSize) {
        return new C2436lv<>(expectedSize);
    }
    ...
    public Object A0K(@CheckForNull Object key) {
        ...
        int iA00 = A00();
        int iA06 = AbstractC2439ly.A06(key, null, iA00, A0C(), A0T(), A0V(), null);
        if (iA06 == -1) {
            Object obj = A0B;
            String[] strArr = A0A;
            String str = strArr[7];
    ...
    private void A0O(int mask) {
        int hashTableBits = AbstractC2439ly.A04(this.A03, 32 - Integer.numberOfLeadingZeros(mask), 31);
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.lv != com.google.common.collect.CompactHashMap<K, V> */
    public int A0Z() {
        AbstractC2279jA.A0F(A0p(), A0L(0, 24, Sdk.SDKError.Reason.TPAT_ERROR_VALUE));
        int i10 = this.A03;
        int buckets = AbstractC2439ly.A01(i10);
        this.A05 = AbstractC2439ly.A07(buckets);
    ...
    public void A0l(int expectedSize) {
        AbstractC2279jA.A0E(expectedSize >= 0, A0L(24, 26, 16));
    ...
    public void A0o(@ParametricNullness int entryIndex, @ParametricNullness K key, V value, int hash, int mask) {
        A0P(entryIndex, AbstractC2439ly.A04(hash, 0, mask));
        A0Q(entryIndex, key);
