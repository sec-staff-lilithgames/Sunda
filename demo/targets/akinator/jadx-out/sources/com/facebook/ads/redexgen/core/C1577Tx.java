...
public final class C1577Tx {
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public final synchronized C1568To A06(int i10, byte[] bArr, int i11, int[] iArr, int i12) throws IOException {
        C1576Tw c1576TwA00 = A00();
        int i13 = 1;
        if (i10 < 0) {
        ...
        while (true) {
            ...
            long j11 = c1576TwA00.A03[i14];
            long j12 = (i14 == c1576TwA00.A00 - i13 ? c1576TwA00.A01 : c1576TwA00.A03[i14 + 1]) - j11;
            if (j10 == -1) {
                j10 = j11;
            }
        ...
        if (i14 <= i10) {
            return new C1568To(z10 ? EnumC1567Tn.A04 : EnumC1567Tn.A05, i10, i10, 0);
        }
        c1576TwA00.A02.seek(j10);
        c1576TwA00.A02.read(bArr, i11, i15);
        return new C1568To(EnumC1567Tn.A03, i10, i14, i15);
    }
    ...
    public final synchronized boolean A09(byte[] bArr) throws IOException {
        ...
        A03(c1576TwA00.A00, c1576TwA00.A01);
        A04(c1576TwA00.A01, bArr);
        c1576TwA00.A02.getFD().sync();
        c1576TwA00.A00++;
        c1576TwA00.A01 += bArr.length;
        return true;
    }
    ...
    public C1577Tx(File file) throws IOException {
        this.A02 = file;
        if (!file.exists()) {
            this.A00 = C1576Tw.A03(file);
        } else if (!file.isFile()) {
            throw new IOException(String.format(Locale.US, A01(25, 32, 2), file.getCanonicalPath()));
        }
    }

    private C1576Tw A00() throws IOException {
        if (!this.A01) {
            if (this.A00 == null) {
                this.A00 = C1576Tw.A04(this.A02);
            }
            return this.A00;
        }
    ...
    private void A03(int i10, long j10) throws IOException {
        ...
        this.A00.A02.seek(C1576Tw.A02(i10));
