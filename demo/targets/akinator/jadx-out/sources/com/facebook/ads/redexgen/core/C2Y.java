...
public final class C2Y extends AbstractC1144Da {
    ...
    public final AbstractC1560Tf<DO> A00;

    public C2Y(C1937dL c1937dL) {
        this(c1937dL, null);
    }

    public C2Y(C1937dL c1937dL, AttributeSet attributeSet) {
        this(c1937dL, attributeSet, 0);
    }

    public C2Y(C1937dL c1937dL, AttributeSet attributeSet, int i10) {
        super(c1937dL, attributeSet, i10);
        this.A00 = new C1141Cx(this);
