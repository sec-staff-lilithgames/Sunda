...
public class C1507Rd {
    ...
    public C1507Rd(String str, String str2, String str3, boolean z10, String str4) {
        this.A03 = str;
        this.A02 = str2;
        this.A01 = str3;
        this.A04 = z10;
    ...
    public static C1507Rd A00(JSONObject jSONObject) throws JSONException {
        return new C1507Rd(jSONObject.getString(A01(30, 3, 49)), jSONObject.getString(A01(26, 4, 87)), jSONObject.optString(A01(5, 9, 106)), jSONObject.getString(A01(14, 8, 37)).equals(A01(22, 4, 109)), jSONObject.optString(A01(0, 5, 69)));
    }
}
