...
public final class C1538Sj {
    ...
    public C1538Sj(String str, Map<String, String> mStaticEnvironmentData) {
        this(str, mStaticEnvironmentData, false);
    }

    public C1538Sj(String str, Map<String, String> map, boolean z10) {
        this.A01 = str;
        this.A02 = map;
