...
public final class RO implements NativeAdsManagerApi {
    ...
    public final void loadAds(NativeAdBase.MediaCacheFlag mediaCacheFlag) {
        V6 v62 = V6.A06;
        int i10 = this.A06;
        C2177hK c2177hK = this.A02;
        this.A02 = new C2177hK(this.A07, this.A08, v62, null, i10);
        if (this.A05) {
            this.A02.A06();
        }
        this.A02.A09(this.A03);
        this.A02.A08(new C2074fa(this, this.A07, mediaCacheFlag));
        this.A02.A07();
    }
    ...
    public final NativeAd nextNativeAd(NativeAdListener nativeAdListener) {
        ...
        if (nativeAdListener != null) {
            ((C1480Qc) nativeAd.getInternalNativeAd()).A1U(nativeAd, nativeAdListener);
        }
