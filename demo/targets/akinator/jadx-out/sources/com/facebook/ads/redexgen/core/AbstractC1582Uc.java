...
public abstract class AbstractC1582Uc {
    ...
    public static List<String> A02(C1937dL c1937dL, JSONArray jSONArray) {
        ArrayList arrayList = new ArrayList();
        for (int eventIndex = 0; eventIndex < jSONArray.length(); eventIndex++) {
            try {
                arrayList.add(jSONArray.getString(eventIndex));
            } catch (JSONException e10) {
                c1937dL.A08().AAy(A00(39, 17, 76), AbstractC1550Sv.A1C, new C1551Sw(e10));
            }
        }
        return arrayList;
    }

    public static void A04(View view, C1580Ua c1580Ua, UZ uz) {
        view.addOnAttachStateChangeListener(new ViewOnAttachStateChangeListenerC1581Ub(c1580Ua, uz));
    }

    public static void A05(C1937dL c1937dL, String str, long j10) {
        US adEventManager = c1937dL.A0A();
        C1580Ua c1580Ua = new C1580Ua(str, adEventManager);
        HashMap map = new HashMap();
        map.put(A00(24, 15, 67), XG.A07(j10));
        map.put(A00(12, 12, 71), XG.A05(j10));
        c1580Ua.A04(UZ.A0D, map);
    }

    public static void A06(C1937dL c1937dL, JSONObject jSONObject, long j10, String str) {
        ...
        if (TextUtils.isEmpty(str) && jSONArrayOptJSONArray != null) {
            A07(c1937dL, jSONObjectOptJSONObject, A02(c1937dL, jSONArrayOptJSONArray), j10, null);
            return;
        }
        ...
        A07(c1937dL, jSONObjectOptJSONObject, A03.get(str), j10, str);
    }

    public static void A07(C1937dL c1937dL, JSONObject jSONObject, List<String> list, long j10, String str) {
        String strA00 = A00(0, 2, 106);
        if (jSONObject.has(strA00)) {
            String clientToken = jSONObject.optString(strA00);
            A08(clientToken, str);
            A09(clientToken, list);
            A05(c1937dL, clientToken, j10);
        }
    }
