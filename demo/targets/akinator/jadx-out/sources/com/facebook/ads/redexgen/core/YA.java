...
public final class YA extends RelativeLayout {
    ...
    public static final int A08 = (int) (AbstractC1640Wl.A02 * 60.0f);
    public static final int A07 = (int) (AbstractC1640Wl.A02 * 8.0f);
    public static final int A09 = (int) (AbstractC1640Wl.A02 * 16.0f);
    public static final int A0A = (int) (AbstractC1640Wl.A02 * 24.0f);
    public static final int A06 = (int) (AbstractC1640Wl.A02 * 12.0f);

    public YA(C1937dL c1937dL, int i10, int i11, String str, String str2, String str3, String str4, Bitmap bitmap) {
        super(c1937dL);
        this.A05 = new TextView(c1937dL);
        this.A02 = new Button(c1937dL);
        this.A01 = new Button(c1937dL);
        this.A03 = new ImageView(c1937dL);
        this.A04 = new LinearLayout(c1937dL);
