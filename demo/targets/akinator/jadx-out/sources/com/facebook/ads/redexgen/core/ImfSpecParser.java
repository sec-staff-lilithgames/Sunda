...
public final class ImfSpecParser {
    ...
    public static final List<ImfDataTrack> A01(String str) throws JSONException {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            C2628p6.A06(string2);
            C2628p6.A06(string3);
            C2196hd c2196hd = new C2196hd(string2, string3);
            ...
            for (int i11 = 0; i11 < length2; i11++) {
                ...
                C2628p6.A06(string);
                arrayList.add(new ImfDataTrack(string, j10, j11, c2196hd, new C2195hc(jSONObject3.getDouble(A00(69, 9, Sdk.SDKError.Reason.PROTOBUF_SERIALIZATION_ERROR_VALUE)), jSONObject3.getDouble(A00(78, 9, 61)), jSONObject3.getDouble(A00(56, 13, 67)), jSONObject3.getDouble(A00(42, 14, 35)), jSONObject3.getDouble(A00(87, 15, 35)))));
            }
        }
        return arrayList;
    }
