...
public enum EnumC2636pK {
    ...
    public static EnumC2636pK[] valuesCustom() {
        EnumC2636pK[] enumC2636pKArrValuesCustom = values();
        if (A01[4].length() == 0) {
            throw new RuntimeException();
        }
        A01[5] = "kC8OQjnUJR";
        return (EnumC2636pK[]) enumC2636pKArrValuesCustom.clone();
    }
