...
public enum EnumC2213i2 {
    ...
    public static EnumC2213i2[] valuesCustom() {
        EnumC2213i2[] enumC2213i2Arr = (EnumC2213i2[]) values().clone();
        String[] strArr = A01;
        if (strArr[5].charAt(20) == strArr[4].charAt(20)) {
            throw new RuntimeException();
        }
        A01[3] = "UcBpUNe8sR";
        return enumC2213i2Arr;
    }
}
