...
public abstract class p8 {
    ...
    public static final Object[] A02(Collection<?> collection) {
        C2628p6.A09(collection, A00(0, 10, 17));
        ...
        while (true) {
            ...
            if (i11 >= length) {
                ...
                C2628p6.A08(objArrCopyOf, strA00);
                i10 = i11;
            } else {
                if (!it.hasNext()) {
                    Object[] objArrCopyOf2 = Arrays.copyOf(objArrCopyOf, i11);
                    C2628p6.A08(objArrCopyOf2, strA00);
                ...
                if (!it.hasNext()) {
                    ...
                    if (size$iv != $i$f$toArrayImpl2) {
                        ...
                        if (size <= length) {
                            ...
                            C2628p6.A07(objNewInstance, A00(21, 62, 11));
