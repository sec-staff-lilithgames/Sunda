...
public final class C2634pF {
    ...
    public /* synthetic */ C2634pF(AbstractC2629p7 abstractC2629p7) {
        this();
    }
    ...
    public final int A02(Collection<?> collection) {
        C2628p6.A09(collection, A00(31, 1, 39));
        int i10 = 1;
    ...
    public final boolean A06(Collection<?> collection, Collection<?> collection2) {
        C2628p6.A09(collection, A00(31, 1, 39));
        C2628p6.A09(collection2, A00(50, 5, 95));
        ...
        while (it2.hasNext()) {
            if (!C2628p6.A0C(it2.next(), it.next())) {
                return false;
            }
        }
        return true;
