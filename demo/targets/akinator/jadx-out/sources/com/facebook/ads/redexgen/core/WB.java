...
public final class WB {
    ...
    public static final Set<C1937dL> A06;
    ...
    public static void A08() {
        A00 = new byte[]{89, 54, 51, 57, 32, 40, 54, 51, 40, 56, 53, 61, 40, 62, 51, 40, 60, 50, 46, 57, 86, 83, 89, 64, 72, 88, 69, 94, 80, 94, 89, 86, 91, 72, 82, 79, 67, 69, 86, 68, 21, 122, AbstractJsonLexerKt.TC_INVALID, 117, 108, 100, 104, 122, 109, 126, AbstractJsonLexerKt.TC_INVALID, 100, 104, 111, 122, 111, 126, 100, AbstractJsonLexerKt.TC_INVALID, 122, 111, 122, 75, 121, 110, 125, 124, 56, 107, 108, 121, 108, 125, 56, 122, 109, 118, 124, 116, 125, 56, 113, 107, 56, 125, 117, 104, 108, 97, 57, 23, 21, 2, 41, 3, 2, 31, 26, 26, 21, 36, 24, 23, 18, 30, 21, 15, 36, 15, 20, 16, 30, 21, 100, 104, 106, 41, 97, 102, 100, 98, 101, 104, 104, 108, 41, 102, 99, 116, 41, 110, 105, 115, 98, 117, 105, 102, 107, 41, 110, 119, 100, 41, 70, 114, 99, 110, 98, 105, 100, 98, 73, 98, 115, 112, 104, 117, 108, 85, 98, 106, 104, 115, 98, 70, 100, 115, 110, 113, 110, 115, 126, 109, 100, 107, 97, 105, 96, 80, 119, 108, 67, 106, 119, 87, 96, 118, 112, 105, 113, 15, 8, 29, 14, 8, 61, 31, 8, 21, 10, 21, 8, 5, 3, 4, 17, 2, 4, 49, 19, 4, 25, 6, 25, 4, 9, 54, 31, 2, 34, 21, 3, 5, 28, 4};
    }
    ...
    public static int A00(C1937dL c1937dL, Intent intent) throws W9 {
        Intent intentA01 = A01(intent);
        int usedContext = 0;
        try {
            Activity activityA00 = ActivityUtils.A00();
            if (activityA00 == null) {
                activityA00 = c1937dL.A0E();
                usedContext = 1;
            }
            if (activityA00 != null) {
            ...
            c1937dL.startActivity(intentA01);
            return 2;
    ...
    public static C1937dL A04(Intent intent) {
        String stringExtra = intent.getStringExtra(A03);
        if (stringExtra != null) {
            for (C1937dL c1937dL : A06) {
                String adId = c1937dL.A0F().getId();
    ...
    public static AdActivityIntent A05(C1937dL c1937dL) {
        AdActivityIntent adActivityIntent = new AdActivityIntent(c1937dL.getApplicationContext(), A06());
        adActivityIntent.putExtra(A03, c1937dL.A0F().getId());
        A06.add(c1937dL);
    ...
    public static void A0B(C1937dL c1937dL, AdActivityIntent adActivityIntent) throws W9 {
        Context launchContext;
        Context applicationContext = c1937dL.getApplicationContext();
        if (U7.A2V(c1937dL) && (launchContext = c1937dL.A0E()) != null) {
        ...
        try {
            if (ProcessUtils.isRemoteRenderingProcess()) {
                if (!A0I(c1937dL, adActivityIntent)) {
                    c1937dL.A0F().AHS();
                    return;
                }
                return;
    ...
    public static boolean A0D(C1937dL c1937dL, Intent intent) throws W9 {
        A07.get();
        return A0F(c1937dL, intent, null);
    }

    public static boolean A0E(C1937dL c1937dL, Intent intent) throws W9 {
        A07.get();
        if (0 != 0) {
            ...
            if (activityA0E != null) {
                ...
                try {
                    ...
                    c1937dL.A08().AAy(A07(90, 8, 57), AbstractC1550Sv.A07, new C1551Sw(e11));
                    return false;
                }
            }
        }
    ...
    public static boolean A0F(C1937dL c1937dL, Intent intent, WK wk2) throws W9 {
        if (A0C(intent, U7.A0Z(c1937dL))) {
            return false;
        }
        Context context = c1937dL;
        if (A01[1].charAt(5) != 'g') {
            A01[2] = "mGLT8eS8inmCxtBfGXr0XCfYNSNKmj30";
            Context startContext = c1937dL.A0E();
            if (startContext != null) {
                context = startContext;
            } else {
                intent.addFlags(268435456);
            }
            if (wk2 != null && !A0C(intent, U7.A0b(c1937dL))) {
                c1937dL.A0C();
                try {
                    ...
                    c1937dL.A08().AAy(A07(90, 8, 57), AbstractC1550Sv.A08, new C1551Sw(e11));
                    return false;
                }
            }
            try {
    ...
    public static boolean A0G(C1937dL c1937dL, Uri uri, String str) throws ActivityNotFoundException {
        A08.get();
        return A0H(c1937dL, uri, str, null);
    }

    public static boolean A0H(C1937dL c1937dL, Uri uri, String str, WM wm2) throws ActivityNotFoundException {
        if (wm2 == null || c1937dL.A0E() == null) {
            return false;
        }
    ...
    public static boolean A0I(C1937dL c1937dL, AdActivityIntent adActivityIntent) throws W9 {
        Intent intentA01 = A01(adActivityIntent);
        try {
            Activity currentActivity = ActivityUtils.A00();
            if (currentActivity == null) {
                currentActivity = c1937dL.A0E();
            }
            if (currentActivity == null) {
                return false;
            }
