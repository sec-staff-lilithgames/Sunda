...
public abstract class EnumC2039f0 {
    ...
    public static final /* synthetic */ EnumC2039f0[] A02;
    public static final EnumC2039f0 A03;
    public static final EnumC2039f0 A04;
    public static final EnumC2039f0 A05;
    public static final EnumC2039f0 A06;
    public static final EnumC2039f0 A07;
    public static final EnumC2039f0 A08;
    ...
    public static void A03() {
        A00 = new byte[]{20, 39, 39, 52, 44, 71, 106, 106, 105, 96, 100, 107, 102, 77, 87, 64, 78, 71, 105, 78, 84, 95, 114, 122, 117, 115, 100, 46, 9, 15, 20, 19, 26, 94, 101, 96, 101, 100, 124, 101, 43, AbstractJsonLexerKt.TC_INVALID, 114, 123, 110, 43, 100, 109, 43, 97, 120, 100, 101, 43, 100, 105, 97, 110, 104, AbstractJsonLexerKt.TC_INVALID, 43, 96, 110, 114};
    }
    ...
    static {
        ...
        final int i10 = 0;
        A03 = new EnumC2039f0(strA02, i10) { // from class: com.facebook.ads.redexgen.X.C5
            @Override // com.facebook.ads.redexgen.core.EnumC2039f0
            ...
            public final boolean A06(JSONArray jSONArray, JSONArray jSONArray2, int i11) {
                return AbstractC2040f1.A00(jSONArray.optJSONArray(i11), jSONArray2.optJSONArray(i11));
            }
            ...
            public final boolean A08(JSONObject jSONObject, JSONObject jSONObject2, String str) {
                return AbstractC2040f1.A00(jSONObject.optJSONArray(str), jSONObject2.optJSONArray(str));
            }
        };
        final String strA022 = A02(5, 7, 74);
        final int i11 = 1;
        A04 = new EnumC2039f0(strA022, i11) { // from class: com.facebook.ads.redexgen.X.C4
            @Override // com.facebook.ads.redexgen.core.EnumC2039f0
        ...
        final int i12 = 2;
        A05 = new EnumC2039f0(strA023, i12) { // from class: com.facebook.ads.redexgen.X.C3
        ...
        final int i13 = 3;
        A06 = new EnumC2039f0(strA024, i13) { // from class: com.facebook.ads.redexgen.X.C2
        ...
        final int i14 = 4;
        A07 = new EnumC2039f0(strA025, i14) { // from class: com.facebook.ads.redexgen.X.C1
            @Override // com.facebook.ads.redexgen.core.EnumC2039f0
            ...
            public final boolean A06(JSONArray jSONArray, JSONArray jSONArray2, int i15) {
                return AbstractC2040f1.A02(jSONArray.optJSONObject(i15), jSONArray2.optJSONObject(i15));
            }
            ...
            @Override // com.facebook.ads.redexgen.core.EnumC2039f0
            public final boolean A08(JSONObject jSONObject, JSONObject jSONObject2, String str) {
                return AbstractC2040f1.A02(jSONObject.optJSONObject(str), jSONObject2.optJSONObject(str));
            }
        };
        final String strA026 = A02(27, 6, 50);
        final int i15 = 5;
        A08 = new EnumC2039f0(strA026, i15) { // from class: com.facebook.ads.redexgen.X.Bz
            @Override // com.facebook.ads.redexgen.core.EnumC2039f0
    ...
    public EnumC2039f0(String str, int i10) {
    }

    public static EnumC2039f0 A00(JSONArray jSONArray, int i10) {
        for (EnumC2039f0 type : values()) {
    ...
    public static EnumC2039f0 A01(JSONObject jSONObject, String str) {
        for (EnumC2039f0 type : values()) {
            String[] strArr = A01;
    ...
    public static /* synthetic */ EnumC2039f0[] A04() {
        return new EnumC2039f0[]{A03, A04, A05, A06, A07, A08};
    }

    public static EnumC2039f0 valueOf(String str) {
        return (EnumC2039f0) Enum.valueOf(EnumC2039f0.class, str);
    }

    public static EnumC2039f0[] values() {
        return (EnumC2039f0[]) A02.clone();
    }
}
