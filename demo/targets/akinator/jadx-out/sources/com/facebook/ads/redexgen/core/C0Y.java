...
public final class C0Y<K, V> extends AbstractC08581i<K, V>.SortedAsMap implements NavigableMap<K, Collection<V>> {
    ...
    private final Map.Entry<K, Collection<V>> A01(Iterator<Map.Entry<K, Collection<V>>> entryIterator) {
        ...
        return AbstractC2562nz.A01(next.getKey(), this.A00.A0G(collectionA0D));
    }
    ...
    public C0Y(final AbstractC08581i this$0, NavigableMap<K, Collection<V>> submap) {
        super(this$0, submap);
        this.A00 = this$0;
    }
