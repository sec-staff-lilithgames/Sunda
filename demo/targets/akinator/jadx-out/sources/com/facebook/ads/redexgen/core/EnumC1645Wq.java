...
public enum EnumC1645Wq {
    ...
    EnumC1645Wq(int i10, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i10;
        this.A01 = nativeComponentTag;
    }

    @Nullable
    public static EnumC1645Wq A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        for (EnumC1645Wq enumC1645Wq : values()) {
            if (enumC1645Wq.A01 == nativeComponentTag) {
                return enumC1645Wq;
            }
        }
        return null;
    ...
    public static void A03(@Nullable View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC1645Wq internalTag = A00(nativeComponentTag);
        if (view != null && internalTag != null) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(@Nullable View view, @Nullable EnumC1645Wq enumC1645Wq) {
        if (view != null && enumC1645Wq != null) {
            view.setTag(A02, enumC1645Wq);
        }
    }
