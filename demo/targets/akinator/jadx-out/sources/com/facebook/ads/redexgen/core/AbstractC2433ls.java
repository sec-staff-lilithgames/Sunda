...
public abstract class AbstractC2433ls<T> implements Iterator<T> {
    public int A00;
    public int A01;
    public int A02;
    public final /* synthetic */ C2436lv A03;
    ...
    public AbstractC2433ls(final C2436lv this$0) {
        this.A03 = this$0;
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.ls != com.google.common.collect.CompactHashMap<K, V>$Itr<T> */
    public /* synthetic */ AbstractC2433ls(C2436lv c2436lv, B9 b92) {
        this(c2436lv);
    }
    ...
    public final void remove() {
        A01();
        AbstractC2426ll.A04(this.A02 >= 0);
        A02();
