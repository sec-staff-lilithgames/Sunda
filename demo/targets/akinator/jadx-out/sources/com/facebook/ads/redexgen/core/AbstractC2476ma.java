...
public abstract class AbstractC2476ma<E> extends AbstractCollection<E> implements Serializable {
    ...
    public abstract AbstractC1081Am<E> A0J();
    ...
    public final <T> T[] toArray(T[] tArr) {
        AbstractC2279jA.A04(tArr);
        int size = size();
        if (tArr.length < size) {
            Object[] objArrA0L = A0L();
            if (objArrA0L != null) {
                return (T[]) AbstractC2595oY.A02(objArrA0L, A0H(), A0G(), tArr);
            }
            tArr = (T[]) AbstractC2589oR.A05(tArr, size);
