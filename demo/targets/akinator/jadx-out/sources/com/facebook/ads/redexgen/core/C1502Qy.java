...
public final class C1502Qy implements AdSettingsApi {
    ...
    public static void A01() {
        A00 = new byte[]{14, 5, 23, 15, 8, 14, 3, 24, 25, 10, 21, 31, 25, 3, 21, 24, 3, 20, 29, 15, 20, 3, 23, 25, 5, 90, 107, 125, 122, 46, 99, 97, 106, 107, 46, 106, 107, 120, 103, 109, 107, 46, 102, 111, 125, 102, 52, 46, 71, 120, 117, 126, 48, 100, 117, 99, 100, 121, 126, 119, 48, 105, AbstractJsonLexerKt.TC_INVALID, 101, 98, 48, 113, 96, 96, 48, 103, 121, 100, 120, 48, 86, 113, 115, 117, 114, AbstractJsonLexerKt.TC_INVALID, AbstractJsonLexerKt.TC_INVALID, 123, 55, 99, 48, 113, 116, 48, 101, 126, 121, 100, 99, 48, 105, AbstractJsonLexerKt.TC_INVALID, 101, 48, 125, 101, 99, 100, 48, 99, 96, 117, 115, 121, 118, 105, 48, 100, 120, 117, 48, 116, 117, 102, 121, 115, 117, 48, 120, 113, 99, 120, 117, 116, 48, 89, 84, 48, 100, AbstractJsonLexerKt.TC_INVALID, 48, 117, 126, 99, 101, 98, 117, 48, 100, 120, 117, 48, 116, 117, 124, 121, 102, 117, 98, 105, 48, AbstractJsonLexerKt.TC_INVALID, 118, 48, 100, 117, 99, 100, 48, 113, 116, 99, 60, 48, 113, 116, 116, 48, 100, 120, 117, 48, 118, AbstractJsonLexerKt.TC_INVALID, 124, 124, AbstractJsonLexerKt.TC_INVALID, 103, 121, 126, 119, 48, 115, AbstractJsonLexerKt.TC_INVALID, 116, 117, 48, 114, 117, 118, AbstractJsonLexerKt.TC_INVALID, 98, 117, 48, 124, AbstractJsonLexerKt.TC_INVALID, 113, 116, 121, 126, 119, 48, 113, 126, 48, 113, 116, 42, 48, 81, 116, 67, 117, 100, 100, 121, 126, 119, 99, 62, 113, 116, 116, 68, 117, 99, 100, 84, 117, 102, 121, 115, 117, 56, 50, 7, 6, 21, 10, 0, 6, 42, 7, 43, 2, 16, 11, 103, 111, 111, 103, 108, 101, 95, 115, 100, 107, 126, 105, 102, 16, 4, 9, 30, 94, 80, 22, 124, 104, 101, 114, 50, 60, 126, 122};
    }
    ...
    public final boolean isTestMode(Context context) {
        if (!AdInternalSettings.isDebugBuild() && !AdInternalSettings.isExplicitTestMode()) {
            ...
            if (!collection.contains(str)) {
                ...
                if (string == null) {
                    SharedPreferences sharedPreferencesA00 = AbstractC1609Ve.A00(context);
                    String strA002 = A00(PsExtractor.VIDEO_STREAM_MASK, 12, 44);
