...
public class C2346kG<V> implements Iterator<V> {
    public final Collection<V> A00;
    public final Iterator<V> A01;
    public final /* synthetic */ C2347kH A02;
    ...
    public C2346kG(final C2347kH this$1) {
        this.A02 = this$1;
        this.A00 = this.A02.A00;
        this.A01 = AbstractC08581i.A05(this$1.A00);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.kG != com.google.common.collect.AbstractMapBasedMultimap<K, V>$WrappedCollection$WrappedIterator */
    public C2346kG(final C2347kH this$1, Iterator<V> delegateIterator) {
        this.A02 = this$1;
        this.A00 = this.A02.A00;
    ...
    public final void remove() {
        this.A01.remove();
        AbstractC08581i.A01(this.A02.A04);
        this.A02.A05();
    }
}
