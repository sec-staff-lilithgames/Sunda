...
public final class ViewpointViewNode implements DspViewableNode {
    ...
    public static final C2646pe A03;
    public static final WeakHashMap<View, ViewpointViewNode> A04;
    public final WeakReference<View> A00;

    public /* synthetic */ ViewpointViewNode(View view, AbstractC2629p7 abstractC2629p7) {
        this(view);
    }
    ...
    public static void A03() {
        byte[] bArr = {35, 57, 56, 11, 32, 35, 46, 45, 32, 30, 41, 47, 56, 70, 92, 93, 110, 69, 70, 75, 72, 69, AbstractJsonLexerKt.TC_INVALID, 64, 90, 64, 75, 69, 76, 123, 76, 74, 93, 62, 33, 45, Utf8.REPLACEMENT_BYTE, 56, 39, 58, 60, 26, 45, 43, 60};
        String[] strArr = A02;
    ...
    public final boolean A9Q(Rect rect, Rect rect2, Rect rect3) {
        C2628p6.A09(rect, A01(13, 20, 52));
        C2628p6.A09(rect2, A01(0, 13, 81));
        C2628p6.A09(rect3, A01(33, 12, 85));
        View view = this.A00.get();
        if (view == null) {
            return false;
        }
        return AbstractC2645pd.A00(view, rect, rect2, rect3);
    }
    ...
    public final boolean equals(Object other) {
        ...
        if (other != null) {
            ...
            return C2628p6.A0C(cls, getClass()) && (view = this.A00.get()) != null && view == ((ViewpointViewNode) other).A00.get();
        }
        return false;
    }
