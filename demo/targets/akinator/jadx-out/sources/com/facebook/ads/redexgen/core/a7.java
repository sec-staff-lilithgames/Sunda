...
public final class a7 extends View {
    ...
    public static void A01() {
        A0D = new byte[]{96, 98, AbstractJsonLexerKt.TC_INVALID, 119, 98, 117, 99, 99};
    }

    static {
        A01();
        A0F = (int) (AbstractC1640Wl.A02 * 5.0f);
        A0G = (int) (AbstractC1640Wl.A02 * 4.0f);
        A0H = (int) (AbstractC1640Wl.A02 * 10.0f);
    }

    public a7(C1937dL c1937dL, boolean z10) {
        super(c1937dL);
