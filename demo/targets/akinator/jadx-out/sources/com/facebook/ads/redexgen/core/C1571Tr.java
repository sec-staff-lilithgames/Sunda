...
public final class C1571Tr {
    ...
    public C1571Tr(File file) {
        this.A00 = file;
    }

    public static C1571Tr A00(String str, Context context) throws IOException {
        File filesDir = new File(context.getFilesDir(), A01(64, 9, 96));
        A03(filesDir);
        File fbsdklogDir = new File(filesDir, str);
        A03(fbsdklogDir);
        return new C1571Tr(fbsdklogDir);
    }
    ...
    public static void A03(File file) throws IOException {
        if (file.exists() || file.mkdir()) {
            if (file.isDirectory()) {
                ...
                throw new C1572Ts(String.format(Locale.US, A01(0, 33, 62), file.getCanonicalPath()));
            }
        }
        throw new C1572Ts(String.format(Locale.US, A01(33, 31, 59), file.getCanonicalPath()));
    }

    public final C1571Tr A04(String str) throws IOException {
        File file = new File(this.A00, str);
        A03(file);
        return new C1571Tr(file);
    }
