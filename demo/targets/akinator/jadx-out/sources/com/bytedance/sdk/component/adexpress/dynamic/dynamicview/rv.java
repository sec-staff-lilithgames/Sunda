...
public class rv extends jj implements com.bytedance.sdk.component.adexpress.dynamic.wqx {
    private boolean jpo;

    public rv(Context context, DynamicRootView dynamicRootView, com.bytedance.sdk.component.adexpress.dynamic.cm.xyk xykVar) {
        ...
        if (dynamicRootView.getRenderRequest() != null) {
            if (!dynamicRootView.getRenderRequest().se()) {
    ...
    public boolean zz() {
        ...
        if (view != null) {
            ...
            Drawable drawableWqx = this.jpo ? com.bytedance.sdk.component.utils.dt.wqx(getContext(), "tt_close_btn") : com.bytedance.sdk.component.utils.dt.wqx(getContext(), "tt_skip_btn");
            if (drawableWqx != null) {
                drawableWqx.setAutoMirrored(true);
                ((ImageView) this.prr).setImageDrawable(drawableWqx);
            }
            int iJpo = (int) com.bytedance.sdk.component.adexpress.cm.qk.jpo(this.f18241ju, this.f51if.jd());
            this.prr.setPadding(iJpo, iJpo, iJpo, iJpo);
        }
        setVisibility(8);
        return true;
    }
