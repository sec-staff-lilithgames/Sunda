...
public class jpo extends yd {
    ...
    public void jpo(Context context) {
        ...
        qkVar.setLayoutParams(new LinearLayout.LayoutParams(-2, -2));
        ...
        LinearLayout.LayoutParams layoutParams7 = new LinearLayout.LayoutParams(-1, va.jd(context, 32.0f));
        layoutParams7.topMargin = iJd2;
        this.f21423jj.setLayoutParams(layoutParams7);
        myVar2.addView(this.f21423jj);
    }

    public jpo(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public jpo(Context context, AttributeSet attributeSet, int i10) {
