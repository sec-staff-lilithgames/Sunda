...
/* renamed from: com.bytedance.sdk.openadsdk.component.reward.if, reason: invalid class name */
/* loaded from: classes4.dex */
public class Cif {
    private static volatile Cif jpo;

    /* renamed from: jd, reason: collision with root package name */
    private final Context f19838jd;
    private final jpo.C0106jpo wqx;

    private Cif(Context context) {
        this.f19838jd = context == null ? sq.jpo() : context.getApplicationContext();
        this.wqx = new jpo.C0106jpo("sp_reward_video");
    }
    ...
    public void jpo(String str, dt dtVar) {
        if (com.bytedance.sdk.openadsdk.utils.jd.jpo()) {
            com.bytedance.sdk.openadsdk.common.jpo.jpo("sp_reward_video_new").jpo(str, dtVar);
            return;
        }
    ...
    public void jpo() {
        ...
        if (com.bytedance.sdk.openadsdk.utils.jd.jpo()) {
            com.bytedance.sdk.openadsdk.common.jpo.jpo("sp_reward_video_new").jpo();
            return;
        }
        try {
            boolean zQk = com.bytedance.sdk.openadsdk.core.zz.qk("sp_reward_video");
            if (zQk) {
                str = "files";
            } else {
                str = "shared_prefs";
            }
            File file = new File(this.f19838jd.getDataDir(), str);
            if (file.exists() && file.isDirectory() && (fileArrListFiles2 = file.listFiles(new FileFilter() { // from class: com.bytedance.sdk.openadsdk.component.reward.if.1
                ...
                for (File file2 : fileArrListFiles2) {
                    if (zQk) {
                        ...
                        this.f19838jd.deleteSharedPreferences(file2.getName().replace(".xml", ""));
                    }
                }
            }
        ...
        try {
            File cacheDir = this.f19838jd.getCacheDir();
            if (cacheDir == null || !cacheDir.exists() || !cacheDir.isDirectory() || (fileArrListFiles = cacheDir.listFiles(new FileFilter() { // from class: com.bytedance.sdk.openadsdk.component.reward.if.2
                @Override // java.io.FileFilter
    ...
    public void jpo(AdSlot adSlot, com.bytedance.sdk.openadsdk.core.model.jpo jpoVar) {
        ...
        if (jpoVar == null || jpoVar.jj() == null || !jpoVar.jj().rf()) {
            if (com.bytedance.sdk.openadsdk.utils.jd.jpo()) {
                com.bytedance.sdk.openadsdk.common.jpo.jpo("sp_reward_video_new").jpo(adSlot, jpoVar);
                return;
            }
            if (jpoVar == null || jpoVar.xyk() || adSlot == null || !TextUtils.isEmpty(adSlot.getBidAdm()) || (dtVarJj = jpoVar.jj()) == null || dtVarJj.yyf() == 2) {
                return;
            }
            ...
            synchronized (jpoVar) {
                try {
                    if (!jpoVar.xyk()) {
                        try {
                            this.wqx.jpo(adSlot, jpoVar.au().toString(), strJd);
                        } catch (Throwable unused) {
                            jpoVar.zz();
                        }
                    }
    ...
    public static Cif jpo(Context context) {
        if (jpo == null) {
    ...
    public String jpo(String str, boolean z10) {
        com.bytedance.sdk.openadsdk.common.jpo jpoVarJpo = com.bytedance.sdk.openadsdk.common.jpo.jpo("sp_reward_video_new");
    ...
    public boolean jpo(com.bytedance.sdk.openadsdk.core.model.jpo jpoVar) {
        return com.bytedance.sdk.openadsdk.common.jpo.jpo("sp_reward_video_new").jpo(jpoVar, true);
    }
    ...
    public void jpo(String str) {
        if (com.bytedance.sdk.openadsdk.utils.jd.jpo()) {
            com.bytedance.sdk.openadsdk.common.jpo.jpo("sp_reward_video_new").wqx(str);
        } else {
            this.wqx.jj(str);
        }
    }
