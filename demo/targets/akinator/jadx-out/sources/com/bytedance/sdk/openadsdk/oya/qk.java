...
public class qk extends yd {
    ...
    public com.bytedance.sdk.openadsdk.core.jj.xyk jd(Context context) {
        ...
        xykVarJd.setMaxWidth(va.jd(context, 150.0f));
        xykVarJd.setTextColor(Color.parseColor("#B7B7B7"));
        xykVarJd.setTextSize(2, 15.0f);
    ...
    public void jpo(Context context) {
        ...
        layoutParams3.leftMargin = iJd4;
        layoutParams3.setMarginStart(iJd4);
        ...
        layoutParams4.setMarginStart(iJd2);
        ...
        RelativeLayout.LayoutParams layoutParams5 = new RelativeLayout.LayoutParams(va.jd(context, 70.0f), va.jd(context, 36.0f));
        layoutParams5.addRule(21);
        layoutParams5.addRule(11);
        layoutParams5.addRule(15);
        layoutParams5.rightMargin = iJd4;
        layoutParams5.setMarginEnd(iJd4);
