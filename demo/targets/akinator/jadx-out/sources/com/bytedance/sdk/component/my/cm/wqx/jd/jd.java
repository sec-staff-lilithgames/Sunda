...
public class jd {
    ...
    private int f18806cm;

    /* renamed from: jj, reason: collision with root package name */
    private final int f18807jj;
    private int my;

    /* renamed from: qk, reason: collision with root package name */
    private final int f18808qk;
    ...
    public static final Bitmap.Config f18805jd = Bitmap.Config.ARGB_4444;
    private final int zz = 1280;

    /* renamed from: yd, reason: collision with root package name */
    private final int f18809yd = 83886080;

    public jd(int i10, int i11, ImageView.ScaleType scaleType, Bitmap.Config config, int i12, int i13) {
        this.wqx = config;
        this.f18806cm = i10;
        this.my = i11;
        this.xyk = scaleType;
    ...
    private static int jpo(int i10, int i11, int i12, int i13) {
        if (i10 == 0 && i11 == 0) {
            return i12;
        }
        if (i10 == 0) {
    ...
    public Bitmap jpo(byte[] bArr) {
        ...
        if (this.f18806cm == 0 && this.my == 0) {
            ...
            int iJpo = jpo(this.f18806cm, this.my, i10, i11);
            int iJpo2 = jpo(this.my, this.f18806cm, i11, i10);
            options.inJustDecodeBounds = false;
            options.inSampleSize = jpo(i10, i11, iJpo, iJpo2, this.f18807jj, this.f18808qk);
            bitmapDecodeByteArray = BitmapFactory.decodeByteArray(bArr, 0, bArr.length, options);
    ...
    private void jpo(int i10, int i11) {
        if (i10 > 1280 && i11 > 1280) {
            if (i10 > i11) {
                this.f18806cm = 1280;
                this.my = (i11 * 1280) / i10;
                return;
            } else {
                this.f18806cm = (i10 * 1280) / i11;
                this.my = 1280;
                return;
            }
        }
