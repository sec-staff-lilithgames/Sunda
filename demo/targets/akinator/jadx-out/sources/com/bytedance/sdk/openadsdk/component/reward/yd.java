    ...
    public static void jpo(String str, int i10, String str2, String str3, String str4) throws JSONException {
        try {
            ...
            if (dtVarJpo != null) {
                ...
                if (dtVarJpo.xur() != null) {
                    if (TextUtils.isEmpty(str2)) {
                        dtVarJpo.xur().jpo((String) null);
                        dtVarJpo.xur().jd("");
                    } else {
                        dtVarJpo.xur().jpo(str2);
                        dtVarJpo.xur().jd("Test the downloaded app");
                    }
                    if (TextUtils.isEmpty(str2)) {
                        str2 = str4;
                    } else {
                        dtVarJpo.xur().wqx(str3);
                    }
                    if (!TextUtils.isEmpty(str2)) {
                        if (dtVarJpo.cnl() != null) {
                            dtVarJpo.cnl().jpo(str2);
                        } else {
            ...
            new oya(sq.jpo(), jpoVar).jpo(true);
        } catch (Exception e10) {
            nmd.wqx("PlayableVerityHelper", e10.getMessage());
        }
    }
}
