...
public class wqx extends yd {
    ...
    public void jpo(Context context) {
        ...
        int iJd3 = va.jd(context, 45.0f);
        this.wqx.setLayoutParams(new LinearLayout.LayoutParams(iJd3, iJd3));
        ...
        LinearLayout.LayoutParams layoutParams6 = new LinearLayout.LayoutParams(-1, va.jd(context, 32.0f));
        layoutParams6.topMargin = iJd2;
