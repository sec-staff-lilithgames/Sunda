...
public class zz extends yd {
    ...
    public com.bytedance.sdk.openadsdk.core.jj.xyk jd(Context context) {
        ...
        xykVar.setGravity(16);
        xykVar.setMaxWidth(va.jd(context, 153.0f));
        xykVar.setSingleLine();
        xykVar.setText("Pangle");
    ...
    public void jpo(Context context) {
        ...
        qkVar2.setPadding(iJd4, 0, 0, 0);
        qkVar.addView(qkVar2);
        sq sqVarQk = qk(context);
        this.wqx = sqVarQk;
        int i11 = hna.ykp;
        sqVarQk.setId(i11);
        int iJd5 = va.jd(context, 40.0f);
        ...
        LinearLayout.LayoutParams layoutParams5 = new LinearLayout.LayoutParams(va.jd(context, 130.0f), va.jd(context, 20.0f));
        layoutParams5.leftMargin = iJd2;
        layoutParams5.setMarginStart(iJd2);
        ...
        RelativeLayout.LayoutParams layoutParams7 = new RelativeLayout.LayoutParams(va.jd(context, 80.0f), va.jd(context, 30.0f));
        layoutParams7.addRule(21);
        layoutParams7.addRule(11);
        layoutParams7.addRule(15);
        layoutParams7.rightMargin = iJd;
        layoutParams7.setMarginEnd(iJd);
    ...
    public com.bytedance.sdk.openadsdk.core.jj.xyk wqx(Context context) {
        ...
        xykVarWqx.setMaxWidth(va.jd(context, 153.0f));
        xykVarWqx.setTextColor(-1);
        xykVarWqx.setTextSize(2, 13.0f);
        return xykVarWqx;
    }
    ...
    public zz(Context context, AttributeSet attributeSet, int i10) {
