...
public class cm extends oya<Integer, Integer> {
    public cm(List<com.bytedance.adsdk.jd.qk.jpo<Integer>> list) {
        super(list);
    }
    ...
    public com.bytedance.adsdk.jd.jpo.jd.jpo<Integer, Integer> jpo() {
        return new com.bytedance.adsdk.jd.jpo.jd.jj(this.jpo);
    }
