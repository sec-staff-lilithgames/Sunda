...
public class jpo extends sq {
    public jpo() {
        super(com.bytedance.adsdk.jpo.jd.cm.wqx.DIVISION);
    }
    ...
    public Object jpo(Map<String, JSONObject> map) {
        ...
        return com.bytedance.adsdk.jpo.jd.my.jpo.jpo.jpo((Number) objJpo2, (Number) objJpo);
    }
}
