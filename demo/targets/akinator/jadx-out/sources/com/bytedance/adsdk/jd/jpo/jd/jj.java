...
public class jj extends qk<Integer> {
    public jj(List<com.bytedance.adsdk.jd.qk.jpo<Integer>> list) {
        super(list);
    }
    ...
    public int wqx(com.bytedance.adsdk.jd.qk.jpo<Integer> jpoVar, float f10) {
        ...
        if (this.wqx == null) {
            return com.bytedance.adsdk.jd.jj.my.jpo(jpoVar.xyk(), jpoVar.zz(), f10);
        }
