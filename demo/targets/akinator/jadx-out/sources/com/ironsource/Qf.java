...
public final class Qf implements Gf {
    ...
    private WebView f35368b;

    /* renamed from: c, reason: collision with root package name */
    private final WebView f35369c;

    /* renamed from: d, reason: collision with root package name */
    private final JSONObject f35370d;
    ...
    public static final class a extends WebViewClient {
        ...
        public void onPageFinished(WebView webView, String str) {
            if (!Qf.this.f35371e && str != null && sv.k0.startsWith$default(str, String.valueOf(this.f35374b), false, 2, null)) {
                Qf qf2 = Qf.this;
                List<? extends Object> listListOf = uu.o0.listOf(qf2.f35370d);
                kotlin.jvm.internal.e0.checkNotNull(listListOf, "null cannot be cast to non-null type kotlin.collections.List<kotlin.Any?>");
                qf2.a(qf2.a("onDataReady", listListOf));
                Bf.f33908a.d();
                Qf.this.f35371e = true;
            }
        ...
        public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
            ...
            Bf.f33908a.a(error.toString());
            Kf.f34769a.b("got error during TestSuite web controller loading " + error);
    ...
    public static final class b implements V8 {
        ...
        public void onClosed() {
            this.f35376b.onClosed();
        }

        @Override // com.ironsource.V8
        public void onUIReady() {
            if (Qf.this.f35372f) {
                this.f35376b.onUIReady();
            } else {
                Qf.this.f35367a.postDelayed(new ch(this, 7), 500L);
            }
        }
    }
    ...
    public Qf(TestSuiteActivity activity, V8 uiLifeCycleListener, JSONObject jsonData, String str) {
        ...
        kotlin.jvm.internal.e0.checkNotNullParameter(jsonData, "jsonData");
        this.f35367a = new Handler(activity.getMainLooper());
        this.f35368b = new WebView(activity);
        this.f35369c = new WebView(activity);
        this.f35370d = jsonData;
    ...
    private final void a(TestSuiteActivity testSuiteActivity, V8 v82, String str) {
        WebView webView = this.f35368b;
        WebSettings settings = webView != null ? webView.getSettings() : null;
        if (settings != null) {
            settings.setJavaScriptEnabled(true);
        }
        this.f35369c.getSettings().setJavaScriptEnabled(true);
        this.f35369c.addJavascriptInterface(new Ff(new C3569zf(testSuiteActivity, this.f35367a), new b(v82), this), "TestSuiteBridge");
        this.f35369c.setWebViewClient(new a(str));
        if (str != null && str.length() != 0) {
            this.f35369c.loadUrl(str);
        }
        WebView webView2 = this.f35368b;
        if (webView2 != null) {
        ...
        this.f35367a.postDelayed(new ch(this, 5), 2000L);
        this.f35367a.postDelayed(new ch(v82, 6), 5000L);
    }
    ...
    public static final void a(Qf this$0, String script) {
        kotlin.jvm.internal.e0.checkNotNullParameter(this$0, "this$0");
        kotlin.jvm.internal.e0.checkNotNullParameter(script, "$script");
        this$0.f35369c.loadUrl("javascript:" + script);
    }
    ...
    public final String a(String methodName, List<? extends Object> methodArgs) {
        ...
        String strB = Pf.f35205a.b(methodArgs);
        if (strB.length() > 0) {
            return e3.g.k(str, "(", strB, ")");
        }
        return j1.o2.l(str, "()");
    }
