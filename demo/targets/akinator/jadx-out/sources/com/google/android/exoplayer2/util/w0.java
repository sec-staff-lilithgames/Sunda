...
public final class w0 {
    ...
    public final void a() {
        int i10;
        int i11 = this.f28587c;
        a.checkState(i11 >= 0 && (i11 < (i10 = this.f28586b) || (i11 == i10 && this.f28588d == 0)));
    }

    public final boolean b(int i10) {
        if (2 > i10 || i10 >= this.f28586b) {
            return false;
        }
        byte[] bArr = this.f28585a;
    ...
    public boolean canReadBits(int i10) {
        ...
        int i12 = i10 / 8;
        int i13 = i11 + i12;
        int i14 = (this.f28588d + i10) - (i12 * 8);
        if (i14 > 7) {
            i13++;
            i14 -= 8;
        }
    ...
    public boolean canReadExpGolombCodedNum() {
        ...
        int i11 = this.f28588d;
        int i12 = 0;
        while (this.f28587c < this.f28586b && !readBit()) {
            i12++;
        }
        boolean z10 = this.f28587c == this.f28586b;
        this.f28587c = i10;
        this.f28588d = i11;
    ...
    public boolean readBit() {
        boolean z10 = (this.f28585a[this.f28587c] & (128 >> this.f28588d)) != 0;
        skipBit();
        return z10;
    }
    ...
    public void skipBits(int i10) {
        ...
        int i13 = i11 + i12;
        this.f28587c = i13;
        int i14 = (i10 - (i12 * 8)) + this.f28588d;
        this.f28588d = i14;
        if (i14 > 7) {
            this.f28587c = i13 + 1;
            this.f28588d = i14 - 8;
