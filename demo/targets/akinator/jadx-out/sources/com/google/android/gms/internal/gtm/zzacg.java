...
final class zzacg extends zzyj implements RandomAccess, zzack {
    ...
    private final String zzk(int i10) {
        return i.a(i10, this.zzd, "Index:", ", Size:");
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzaco.zzb;
        collection.getClass();
        if (!(collection instanceof zzacg)) {
            return super.addAll(collection);
        }
        zzacg zzacgVar = (zzacg) collection;
        int i10 = zzacgVar.zzd;
        if (i10 == 0) {
            return false;
        }
        int i11 = this.zzd;
        ...
        System.arraycopy(zzacgVar.zzc, 0, this.zzc, this.zzd, zzacgVar.zzd);
        this.zzd = i12;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzd != zzacgVar.zzd) {
            return false;
        }
        int[] iArr = zzacgVar.zzc;
    ...
    @Override // com.google.android.gms.internal.gtm.zzack
    ...
    public final zzack zzd(int i10) {
        if (i10 >= this.zzd) {
            return new zzacg(i10 == 0 ? zza : Arrays.copyOf(this.zzc, i10), this.zzd, true);
        }
    ...
    private zzacg(int[] iArr, int i10, boolean z10) {
        super(z10);
        this.zzc = iArr;
        this.zzd = i10;
    }
