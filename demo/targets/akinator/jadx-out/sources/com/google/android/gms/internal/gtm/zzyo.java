...
final class zzyo extends zzyj implements RandomAccess, zzacn {
    ...
    public final boolean addAll(Collection collection) {
        ...
        System.arraycopy(zzyoVar.zzb, 0, this.zzb, this.zzc, zzyoVar.zzc);
        this.zzc = i12;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzyoVar.zzc) {
            return false;
        }
        boolean[] zArr = zzyoVar.zzb;
    ...
    public final int hashCode() {
        int iZza = 1;
        for (int i10 = 0; i10 < this.zzc; i10++) {
            iZza = (iZza * 31) + zzaco.zza(this.zzb[i10]);
        }
        return iZza;
    }
    ...
    public final /* bridge */ /* synthetic */ zzacn zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzyo(i10 == 0 ? zza : Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
    ...
    private zzyo(boolean[] zArr, int i10, boolean z10) {
        super(z10);
        this.zzb = zArr;
        this.zzc = i10;
    }
