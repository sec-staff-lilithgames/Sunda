...
final class zzabn extends zzyj implements RandomAccess, zzacn {
    ...
    public final /* bridge */ /* synthetic */ zzacn zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzabn(i10 == 0 ? zza : Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
    ...
    private zzabn(double[] dArr, int i10, boolean z10) {
        super(z10);
        this.zzb = dArr;
        this.zzc = i10;
    }
