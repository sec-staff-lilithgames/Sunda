...
public final class zzdi implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public zzdi(Handler handler, zzdh zzdhVar) {
        this.zzb = handler;
    }
    ...
    public final void zza(int i10) throws zzdj {
        ...
        String str = zzep.zza;
        zzdk.zzf(z10, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", objArr));
