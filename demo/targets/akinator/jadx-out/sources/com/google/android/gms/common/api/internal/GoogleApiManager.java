...
public class GoogleApiManager implements Handler.Callback {
    ...
    private final Set zap = new g();
    private final Set zaq = new g();
    ...
    public static Status zaF(ApiKey apiKey, ConnectionResult connectionResult) {
        return new Status(connectionResult, b.m("API: ", apiKey.zaa(), " is not available on this device. Connection failed with: ", String.valueOf(connectionResult)));
    }
    ...
    @ResultIgnorabilityUnspecified
    public final boolean zaE(ConnectionResult connectionResult, int i10) throws Resources.NotFoundException {
    ...
    public final boolean handleMessage(Message message) {
        ...
        switch (i10) {
            ...
            case 5:
                ...
                if (zabqVar == null) {
                    Log.wtf("GoogleApiManager", o2.k(i11, "Could not find API instance ", " while trying to fail enqueued calls."), new Exception());
                } else if (connectionResult.getErrorCode() == 13) {
                    zabqVar.zaE(new Status(17, b.m("Error resolution was canceled by the user, original error message: ", this.zaj.getErrorString(connectionResult.getErrorCode()), ": ", connectionResult.getErrorMessage())));
                } else {
            ...
            case 19:
                ...
                return true;
            default:
                j1.o2.u(i10, OcvDtWCQ.GiHlpYKQcsI, "GoogleApiManager");
                return false;
        }
    }
}
