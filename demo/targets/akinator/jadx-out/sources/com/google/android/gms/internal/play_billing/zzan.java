...
public interface zzan extends IInterface {
    ...
    void zzm(int i10, String str, Bundle bundle, zzy zzyVar) throws RemoteException;

    void zzn(int i10, String str, Bundle bundle, zzaa zzaaVar) throws RemoteException;

    void zzo(int i10, String str, Bundle bundle, zzac zzacVar) throws RemoteException;

    void zzp(int i10, String str, Bundle bundle, zzae zzaeVar) throws RemoteException;

    void zzq(int i10, String str, Bundle bundle, zzag zzagVar) throws RemoteException;

    void zzr(int i10, String str, Bundle bundle, zzai zzaiVar) throws RemoteException;

    void zzs(int i10, String str, Bundle bundle, zzak zzakVar) throws RemoteException;

    void zzt(int i10, String str, Bundle bundle, zzap zzapVar) throws RemoteException;
