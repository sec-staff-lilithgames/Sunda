...
public final class zzgyi extends zzgxa {
    private final zzgyp zza;
    private final zzhtb zzb;
    private final zzhsz zzc;
    private final Integer zzd;

    public /* synthetic */ zzgyi(zzgyp zzgypVar, zzhtb zzhtbVar, zzhsz zzhszVar, Integer num, byte[] bArr) {
        this.zza = zzgypVar;
        this.zzb = zzhtbVar;
        this.zzc = zzhszVar;
        this.zzd = num;
    ...
    public static zzgyh zzd() {
        return new zzgyh(null);
    }
