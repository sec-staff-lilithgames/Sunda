...
final class zzaew {
    ...
    public static String zzd(byte[] bArr, int i10, int i11) throws zzacq {
        int i12;
        ...
        while (i10 < i13) {
            ...
            if (zzaeu.zzd(b11)) {
                ...
                if (b11 < -32) {
                    ...
                    i12 = i15 + 1;
                    i10 += 2;
                    zzaeu.zzc(b11, bArr[i16], cArr, i15);
                } else if (b11 < -16) {
                    if (i16 >= i13 - 1) {
                        throw new zzacq("Protocol message had invalid UTF-8.");
                    }
                    ...
                    int i17 = i10 + 2;
                    i10 += 3;
                    zzaeu.zzb(b11, bArr[i16], bArr[i17], cArr, i15);
                } else {
                    if (i16 >= i13 - 2) {
                        throw new zzacq("Protocol message had invalid UTF-8.");
                    }
                    ...
                    byte b14 = bArr[i10 + 2];
                    i10 += 4;
                    zzaeu.zza(b11, b13, b14, bArr[i18], cArr, i15);
                    i15 += 2;
                }
                i15 = i12;
            }
