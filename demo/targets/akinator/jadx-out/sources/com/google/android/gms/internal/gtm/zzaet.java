...
final class zzaet {
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.gtm.zzaet.<clinit>():void");
    }
    ...
    public static void zzD(Object obj, long j10, byte b10) {
        zzaes zzaesVar = zzf;
        long j11 = (-4) & j10;
        int i10 = zzaesVar.zza.getInt(obj, j11);
        int i11 = ((~((int) j10)) & 3) << 3;
        zzaesVar.zza.putInt(obj, j11, ((255 & b10) << i11) | (i10 & (~(255 << i11))));
    }
    ...
    public static void zzE(Object obj, long j10, byte b10) {
        ...
        long j11 = (-4) & j10;
        int i10 = (((int) j10) & 3) << 3;
        zzaesVar.zza.putInt(obj, j11, ((255 & b10) << i10) | (zzaesVar.zza.getInt(obj, j11) & (~(255 << i10))));
    }
    ...
    public static /* bridge */ /* synthetic */ void zzh(Throwable th2) {
        Logger.getLogger(zzaet.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th2.toString()));
    }
