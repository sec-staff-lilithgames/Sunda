...
public abstract class zztl extends zzti implements List, RandomAccess {
    ...
    public static zztl zzg(Object[] objArr, int i10) {
        return i10 == 0 ? zztr.zza : new zztr(objArr, i10);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (list instanceof RandomAccess) {
            for (int i10 = 0; i10 < size; i10++) {
                if (!zztc.zza(get(i10), list.get(i10))) {
                    return false;
                }
            }
            return true;
        ...
        while (it.hasNext()) {
            if (!it2.hasNext() || !zztc.zza(it.next(), it2.next())) {
                return false;
            }
        }
        return !it2.hasNext();
    ...
    @Override // java.util.List
    /* renamed from: zzf */
    public zztl subList(int i10, int i11) {
        zztd.zzc(i10, i11, size());
        int i12 = i11 - i10;
        return i12 == size() ? this : i12 == 0 ? zztr.zza : new zztk(this, i10, i12);
    }

    @Override // java.util.List
    /* renamed from: zzh, reason: merged with bridge method [inline-methods] */
    public final zzub listIterator(int i10) {
        zztd.zzb(i10, size(), "index");
        return isEmpty() ? zza : new zztj(this, i10);
    }
}
