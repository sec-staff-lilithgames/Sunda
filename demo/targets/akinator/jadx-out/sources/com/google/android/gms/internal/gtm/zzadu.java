...
final class zzadu extends zzyj implements RandomAccess {
    ...
    public final /* bridge */ /* synthetic */ zzacn zzd(int i10) {
        if (i10 >= this.zzd) {
            return new zzadu(i10 == 0 ? zza : Arrays.copyOf(this.zzc, i10), this.zzd, true);
        }
    ...
    private zzadu(Object[] objArr, int i10, boolean z10) {
        super(z10);
        this.zzc = objArr;
        this.zzd = i10;
    }
