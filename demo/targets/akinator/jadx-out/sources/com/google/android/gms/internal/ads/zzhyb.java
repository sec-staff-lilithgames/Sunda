...
final class zzhyb {
    ...
    public static String zza(zzhxz zzhxzVar, String str) throws SecurityException {
    ...
    public static void zzb(StringBuilder sb2, int i10, String str, Object obj) throws SecurityException {
        ...
        if (obj instanceof String) {
            sb2.append(": \"");
            sb2.append(zzhza.zza(zzhvi.zzs((String) obj)));
            sb2.append(AbstractJsonLexerKt.STRING);
            return;
        }
        if (obj instanceof zzhvi) {
            sb2.append(": \"");
            sb2.append(zzhza.zza((zzhvi) obj));
            sb2.append(AbstractJsonLexerKt.STRING);
            return;
        }
        if (obj instanceof zzhwo) {
            sb2.append(" {");
            zzc((zzhwo) obj, sb2, i10 + 2);
            sb2.append("\n");
            zzd(i10, sb2);
            sb2.append("}");
            return;
    ...
    */
    private static void zzc(com.google.android.gms.internal.ads.zzhxz r18, java.lang.StringBuilder r19, int r20) throws java.lang.SecurityException {
        /*
