...
public final class zzpe implements zzpd {
    ...
    static {
        ...
        zzh = zzkgVarZzb.zzf("measurement.config.url_scheme", HttpRequest.DEFAULT_SCHEME);
        ...
        zzy = zzkgVarZzb.zzc("measurement.alarm_manager.minimum_interval", ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS);
        ...
        zzF = zzkgVarZzb.zzc("measurement.upload.refresh_blacklisted_config_interval", DTBAdRequest.WEEK);
        ...
        zzac = zzkgVarZzb.zzf("measurement.rb.attribution.uri_scheme", HttpRequest.DEFAULT_SCHEME);
        zzad = zzkgVarZzb.zzc("measurement.sdk.attribution.cache.ttl", DTBAdRequest.WEEK);
        ...
        zzag = zzkgVarZzb.zzc("measurement.upload.initial_upload_delay_time", MBInterstitialActivity.WEB_LOAD_TIME);
        ...
        zzau = zzkgVarZzb.zzf(GalEuEfxjome.Azet, "https://app-measurement.com/a");
