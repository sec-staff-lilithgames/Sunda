...
class zzhyy extends AbstractMap {
    ...
    public final Object zzg(int i10) {
        zzh();
        Object value = ((zzhyv) this.zza[i10]).getValue();
        ...
        if (!this.zzc.isEmpty()) {
            ...
            objArr2[i11] = new zzhyv(this, (Comparable) entry.getKey(), entry.getValue());
            this.zzb++;
            it.remove();
        }
        return value;
    ...
    private final int zzm(Comparable comparable) {
        ...
        int i12 = 0;
        if (i11 >= 0) {
            int iCompareTo = comparable.compareTo(((zzhyv) this.zza[i11]).zza());
            if (iCompareTo > 0) {
                return -(i10 + 1);
            }
            if (iCompareTo == 0) {
        ...
        while (i12 <= i11) {
            int i13 = (i12 + i11) / 2;
            int iCompareTo2 = comparable.compareTo(((zzhyv) this.zza[i13]).zza());
            if (iCompareTo2 < 0) {
                i11 = i13 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            if (!zzd(i11).equals(zzhyyVar.zzd(i11))) {
                return false;
            }
        }
        if (i10 != size) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        this.zza[i10] = new zzhyv(this, comparable, obj);
        this.zzb++;
        return null;
    }
