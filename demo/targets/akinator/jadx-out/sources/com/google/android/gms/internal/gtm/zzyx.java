...
public abstract class zzyx implements Iterable, Serializable {
    ...
    public static zzyx zzj(byte[] bArr, int i10, int i11) {
    ...
    public final String toString() {
        ...
        return j1.o2.o(b.r(zzd(), "<ByteString@", hexString, " size=", " contents=\""), zzd() <= 50 ? zzaeh.zza(this) : zzaeh.zza(zzf(0, 47)).concat(APSSharedUtil.TRUNCATE_SEPARATOR), "\">");
    }
    ...
    public abstract zzyx zzf(int i10, int i11);

    public abstract void zzg(zzyp zzypVar) throws IOException;
