...
final class zzhyk extends zzhuu implements RandomAccess {
    ...
    public final /* bridge */ /* synthetic */ zzhxa zzh(int i10) {
        if (i10 >= this.zzd) {
            return new zzhyk(i10 == 0 ? zza : Arrays.copyOf(this.zzc, i10), this.zzd, true);
        }
        throw new IllegalArgumentException();
    }

    private zzhyk(Object[] objArr, int i10, boolean z10) {
        super(z10);
        this.zzc = objArr;
        this.zzd = i10;
    }
