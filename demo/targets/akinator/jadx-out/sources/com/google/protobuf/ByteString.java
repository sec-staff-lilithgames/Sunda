...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    public static class LiteralByteString extends LeafByteString {
        ...
        public final boolean equalsRange(ByteString byteString, int i10, int i11) {
            ...
            if (i12 > byteString.size()) {
                StringBuilder sbF = i.f(i10, i11, "Ran off end of other: ", ", ", ", ");
    ...
    private static int extractHexDigit(String str, int i10) {
        ...
        StringBuilder sbO = g.o("Invalid hexString ", str, " must only contain [0-9a-fA-F] but contained ");
    ...
    public static ByteString fromHex(String str) {
        if (str.length() % 2 != 0) {
            StringBuilder sbO = g.o("Invalid hexString ", str, " of length ");
    ...
    private String truncateAndEscapeForDisplay() {
        return size() <= 50 ? TextFormatEscaper.escapeBytes(this) : j1.o2.o(new StringBuilder(), TextFormatEscaper.escapeBytes(substring(0, 47)), APSSharedUtil.TRUNCATE_SEPARATOR);
    }
    ...
    public final String toString(Charset charset) {
        return size() == 0 ? KGUkpTlXZlJLy.rNsOVkEJ : toStringInternal(charset);
    }
    ...
    public final String toString() {
        ...
        int size = size();
        return j1.o2.o(b.r(size, "<ByteString@", hexString, " size=", " contents=\""), truncateAndEscapeForDisplay(), "\">");
    }
