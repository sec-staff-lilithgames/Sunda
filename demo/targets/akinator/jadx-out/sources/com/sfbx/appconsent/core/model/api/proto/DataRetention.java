...
public final class DataRetention {
    ...
    public static /* synthetic */ DataRetention copy$default(DataRetention dataRetention, int i10, Map map, Map map2, int i11, Object obj) {
        if ((i11 & 1) != 0) {
        ...
        return dataRetention.copy(i10, map, map2);
    }
    ...
    public final DataRetention copy(int i10, Map<String, Integer> purposes, Map<String, Integer> specialPurposes) {
        e0.checkNotNullParameter(purposes, "purposes");
        e0.checkNotNullParameter(specialPurposes, "specialPurposes");
        return new DataRetention(i10, purposes, specialPurposes);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.stdRetention == dataRetention.stdRetention && e0.areEqual(this.purposes, dataRetention.purposes) && e0.areEqual(this.specialPurposes, dataRetention.specialPurposes);
    }
    ...
    @f
    public /* synthetic */ DataRetention(int i10, int i11, Map map, Map map2, SerializationConstructorMarker serializationConstructorMarker) {
    ...
    public /* synthetic */ DataRetention(int i10, Map map, Map map2, int i11, u uVar) {
