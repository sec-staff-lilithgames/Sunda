...
public final class DataRetention$$serializer implements GeneratedSerializer<DataRetention> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.sfbx.appconsent.core.model.api.proto.DataRetention", dataRetention$$serializer, 3);
    ...
    public DataRetention deserialize(Decoder decoder) {
        ...
        return new DataRetention(i10, i12, (Map) objDecodeSerializableElement, (Map) objDecodeSerializableElement2, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, DataRetention value) {
        ...
        DataRetention.write$Self(value, compositeEncoderBeginStructure, descriptor2);
