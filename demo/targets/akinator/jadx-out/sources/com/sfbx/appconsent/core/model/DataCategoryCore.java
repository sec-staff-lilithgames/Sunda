...
public final class DataCategoryCore {
    ...
    public static final void write$Self(DataCategoryCore self, CompositeEncoder output, SerialDescriptor serialDesc) {
        e0.checkNotNullParameter(self, "self");
        e0.checkNotNullParameter(output, "output");
        e0.checkNotNullParameter(serialDesc, "serialDesc");
        output.encodeIntElement(serialDesc, 0, self.f50517id);
        output.encodeSerializableElement(serialDesc, 1, I18NString$$serializer.INSTANCE, self.name);
    }

    public final int component1() {
        return this.f50517id;
    }
    ...
    public final DataCategoryCore copy(int i10, I18NString name) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.f50517id == dataCategoryCore.f50517id && e0.areEqual(this.name, dataCategoryCore.name);
    }
    ...
    public int hashCode() {
        return this.name.hashCode() + (Integer.hashCode(this.f50517id) * 31);
    }

    public String toString() {
        return "DataCategoryCore(id=" + this.f50517id + ", name=" + this.name + ')';
    }

    public DataCategoryCore(int i10, I18NString name) {
        e0.checkNotNullParameter(name, "name");
        this.f50517id = i10;
        this.name = name;
    }
