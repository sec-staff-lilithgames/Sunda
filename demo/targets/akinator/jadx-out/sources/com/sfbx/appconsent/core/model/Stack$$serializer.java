...
public final class Stack$$serializer implements GeneratedSerializer<Stack> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.sfbx.appconsent.core.model.Stack", stack$$serializer, 8);
    ...
    public Stack deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            StringSerializer stringSerializer = StringSerializer.INSTANCE;
            objDecodeSerializableElement2 = compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 2, new LinkedHashMapSerializer(stringSerializer, stringSerializer), null);
            objDecodeSerializableElement3 = compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 3, new LinkedHashMapSerializer(stringSerializer, stringSerializer), null);
            objDecodeSerializableElement = compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 4, new ArrayListSerializer(Consentable$$serializer.INSTANCE), null);
            ...
            while (z10) {
                ...
                switch (iDecodeElementIndex) {
                    ...
                    case 2:
                        ...
                        objDecodeSerializableElement4 = compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 2, new LinkedHashMapSerializer(stringSerializer2, stringSerializer2), objDecodeSerializableElement4);
                        i12 |= 4;
                        i11 = 7;
                    case 3:
                        StringSerializer stringSerializer3 = StringSerializer.INSTANCE;
                        objDecodeSerializableElement5 = compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 3, new LinkedHashMapSerializer(stringSerializer3, stringSerializer3), objDecodeSerializableElement5);
                        i12 |= 8;
                        i11 = 7;
                    case 4:
                        objDecodeSerializableElement6 = compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 4, new ArrayListSerializer(Consentable$$serializer.INSTANCE), objDecodeSerializableElement6);
                        i12 |= 16;
                        i11 = 7;
                    case 5:
        ...
        return new Stack(i10, i13, (Integer) objDecodeNullableSerializableElement2, (Map) objDecodeSerializableElement2, (Map) objDecodeSerializableElement3, (List) objDecodeSerializableElement, (ConsentStatus) objH2, (ConsentStatus) objH, (Integer) objDecodeNullableSerializableElement, (SerializationConstructorMarker) null);
    }
