...
public final class DataRetentionCore$$serializer implements GeneratedSerializer<DataRetentionCore> {
    public static final DataRetentionCore$$serializer INSTANCE;
    public static final /* synthetic */ SerialDescriptor descriptor;

    static {
        DataRetentionCore$$serializer dataRetentionCore$$serializer = new DataRetentionCore$$serializer();
        INSTANCE = dataRetentionCore$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.sfbx.appconsent.core.model.DataRetentionCore", dataRetentionCore$$serializer, 3);
    ...
    private DataRetentionCore$$serializer() {
    }
    ...
    public DataRetentionCore deserialize(Decoder decoder) {
        ...
        return new DataRetentionCore(i10, i12, (Map) objDecodeSerializableElement, (Map) objDecodeSerializableElement2, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, DataRetentionCore value) {
        e0.checkNotNullParameter(encoder, "encoder");
        e0.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        DataRetentionCore.write$Self(value, compositeEncoderBeginStructure, descriptor2);
