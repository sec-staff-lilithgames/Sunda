...
public final class Core$mXchangeRepository$2 extends f0 implements a {
    public static final Core$mXchangeRepository$2 INSTANCE = new Core$mXchangeRepository$2();

    public Core$mXchangeRepository$2() {
        super(0);
    }
