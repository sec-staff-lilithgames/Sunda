...
public final class VendorUrl {
    ...
    public static final void write$Self(VendorUrl self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if (output.shouldEncodeElementDefault(serialDesc, 0) || !e0.areEqual(self.privacy, "")) {
            output.encodeStringElement(serialDesc, 0, self.privacy);
        }
        if (!output.shouldEncodeElementDefault(serialDesc, 1) && e0.areEqual(self.legintClaim, "")) {
            return;
        }
    ...
    public final VendorUrl copy(String privacy, String legintClaim) {
        ...
        e0.checkNotNullParameter(legintClaim, "legintClaim");
    ...
    @f
    public /* synthetic */ VendorUrl(int i10, @SerialName(DtbDeviceRegistration.CONFIG_PRIVACY_KEY) String str, @SerialName("legint_claim") String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if ((i10 & 1) == 0) {
            this.privacy = "";
        } else {
            this.privacy = str;
    ...
    @SerialName(DtbDeviceRegistration.CONFIG_PRIVACY_KEY)
