...
public final class DataRetentionReducer {
    ...
    public static /* synthetic */ DataRetentionReducer copy$default(DataRetentionReducer dataRetentionReducer, int i10, Map map, Map map2, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            i10 = dataRetentionReducer.stdRetention;
        }
        if ((i11 & 2) != 0) {
        ...
        return dataRetentionReducer.copy(i10, map, map2);
    }

    public static final void write$Self(DataRetentionReducer self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    public final DataRetentionReducer copy(int i10, Map<String, Integer> purposes, Map<String, Integer> specialPurposes) {
        e0.checkNotNullParameter(purposes, "purposes");
        e0.checkNotNullParameter(specialPurposes, "specialPurposes");
        return new DataRetentionReducer(i10, purposes, specialPurposes);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.stdRetention == dataRetentionReducer.stdRetention && e0.areEqual(this.purposes, dataRetentionReducer.purposes) && e0.areEqual(this.specialPurposes, dataRetentionReducer.specialPurposes);
    }
    ...
    public String toString() {
        StringBuilder sb2 = new StringBuilder("DataRetentionReducer(stdRetention=");
    ...
    @f
    public /* synthetic */ DataRetentionReducer(int i10, int i11, Map map, Map map2, SerializationConstructorMarker serializationConstructorMarker) {
    ...
    public DataRetentionReducer(int i10, Map<String, Integer> purposes, Map<String, Integer> specialPurposes) {
        e0.checkNotNullParameter(purposes, "purposes");
        e0.checkNotNullParameter(specialPurposes, "specialPurposes");
    ...
    public /* synthetic */ DataRetentionReducer(int i10, Map map, Map map2, int i11, u uVar) {
