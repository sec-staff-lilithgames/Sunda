...
public final class VendorUrl$$serializer implements GeneratedSerializer<VendorUrl> {
    ...
    public VendorUrl deserialize(Decoder decoder) {
        ...
        return new VendorUrl(i10, strDecodeStringElement, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.sfbx.appconsent.core.model.VendorUrl", vendorUrl$$serializer, 2);
        pluginGeneratedSerialDescriptor.addElement(uQjDr.ffGVZybGkjQ, true);
