...
public final class IsGDPRFromCacheUseCaseImpl implements IsGDPRFromCacheUseCase {
    private final AppConsentCore appConsentCore;

    public IsGDPRFromCacheUseCaseImpl(AppConsentCore appConsentCore) {
    ...
    public Boolean get() {
        return Boolean.valueOf(this.appConsentCore.isGdprFromCache());
    }
}
