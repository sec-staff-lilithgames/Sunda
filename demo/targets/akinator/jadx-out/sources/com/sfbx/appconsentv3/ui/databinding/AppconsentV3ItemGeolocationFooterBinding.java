...
public final class AppconsentV3ItemGeolocationFooterBinding implements a {
    ...
    public static AppconsentV3ItemGeolocationFooterBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View viewInflate = layoutInflater.inflate(R.layout.appconsent_v3_item_geolocation_footer, viewGroup, false);
        if (z10) {
