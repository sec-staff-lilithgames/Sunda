...
public final class AppconsentV3CardCopyrightBinding implements a {
    ...
    public static AppconsentV3CardCopyrightBinding bind(View view) {
        int i10 = R.id.card_copyright_text;
        AppCompatTextView appCompatTextView = (AppCompatTextView) b.findChildViewById(view, i10);
        if (appCompatTextView != null) {
            return new AppconsentV3CardCopyrightBinding((LinearLayoutCompat) view, appCompatTextView);
        }
    ...
    public static AppconsentV3CardCopyrightBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
