...
public final class AppConsentTheme$Companion$loadTexts$1$11 extends f0 implements l {
    ...
    public final void invoke(List<TranslatableText> it) {
        ...
        if (textValue == null) {
            textValue = this.$this_apply.getButtonClose$appconsent_ui_v3_prodXchangeRelease();
        }
