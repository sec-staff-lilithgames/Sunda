...
public final class AppconsentV3AcUnorderedCategoryListWidgetBinding implements a {
    ...
    public static AppconsentV3AcUnorderedCategoryListWidgetBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View viewInflate = layoutInflater.inflate(R.layout.appconsent_v3_ac_unordered_category_list_widget, viewGroup, false);
        if (z10) {
