...
public final class AppconsentV3CardDisplayVendorsBinding implements a {
    ...
    public static AppconsentV3CardDisplayVendorsBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View viewInflate = layoutInflater.inflate(R.layout.appconsent_v3_card_display_vendors, viewGroup, false);
        if (z10) {
