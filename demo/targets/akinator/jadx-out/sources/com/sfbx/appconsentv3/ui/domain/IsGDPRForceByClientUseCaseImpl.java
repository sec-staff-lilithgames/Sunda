...
public final class IsGDPRForceByClientUseCaseImpl implements IsGDPRForceByClientUseCase {
    private final AppConsentCore appConsentCore;

    public IsGDPRForceByClientUseCaseImpl(AppConsentCore appConsentCore) {
    ...
    public Boolean get() {
        return Boolean.valueOf(this.appConsentCore.isGdprForcedByClient());
    }
}
