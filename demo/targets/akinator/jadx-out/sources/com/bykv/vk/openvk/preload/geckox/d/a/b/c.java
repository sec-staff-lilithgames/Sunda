...
public class c extends com.bykv.vk.openvk.preload.b.d<Pair<Uri, UpdatePackage>, Pair<com.bykv.vk.openvk.preload.geckox.buffer.a, UpdatePackage>> {
    ...
    private com.bykv.vk.openvk.preload.geckox.b f17125d;

    /* renamed from: e, reason: collision with root package name */
    private File f17126e;

    @Override // com.bykv.vk.openvk.preload.b.d
    public final void a(Object... objArr) {
        super.a(objArr);
        this.f17125d = (com.bykv.vk.openvk.preload.geckox.b) objArr[0];
        this.f17126e = (File) objArr[1];
    }
    ...
    public Object a(com.bykv.vk.openvk.preload.b.b<Pair<com.bykv.vk.openvk.preload.geckox.buffer.a, UpdatePackage>> bVar, Pair<Uri, UpdatePackage> pair) throws Throwable {
        ...
        try {
            this.f17125d.i().downloadFile(string, length, new BufferOutputStream(aVarA));
            try {
            ...
            aVarA.e();
            StringBuilder sbO = g.o("download patch single file failed, url:", string, ", channel:");
