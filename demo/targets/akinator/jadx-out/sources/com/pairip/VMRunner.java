...
public class VMRunner {
    ...
    private static int versionCode = 363;
    ...
    private static byte[] readFullByteArrayFromStream(InputStream is2, byte[] byteArray) throws IOException {
        int i10 = 0;
        while (true) {
            int i11 = is2.read(byteArray, i10, byteArray.length - i10);
            if (i11 <= 0) {
                break;
            }
            i10 += i11;
