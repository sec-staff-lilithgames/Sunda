...
public final class C2948q2 implements InterfaceC3032v2 {

    /* renamed from: a, reason: collision with root package name */
    public final /* synthetic */ HandlerC2964r2 f33278a;

    public C2948q2(HandlerC2964r2 handlerC2964r2) {
        this.f33278a = handlerC2964r2;
    }
    ...
    public final void a(C2897n2 click) {
        ...
        HandlerC2964r2 handlerC2964r2 = this.f33278a;
    ...
    public final void a(C2897n2 click, EnumC3017u4 errorCode) {
        ...
        F5 f52 = this.f33278a.f33300a;
        if (f52 != null) {
            String strF = C3100z2.f();
            ((G5) f52).b(strF, j1.o2.o(N6.a(strF, "access$getTAG$p(...)", "Pinging click ("), click.f33111b, ") via WebView failed ..."));
        }
        C3100z2.c(C3100z2.f33672a, click);
        this.f33278a.b(click);
    }
}
