...
public final class ConfigFileFromLocalStorage$doWork$2 extends n implements p {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            objM7131constructorimpl = z.m7131constructorimpl(!file.exists() ? params.getDefaultConfiguration() : new Configuration(new JSONObject(o.readText$default(file, null, 1, null))));
    ...
    public final Object invoke(CoroutineScope coroutineScope, d<? super z> dVar) {
        return ((ConfigFileFromLocalStorage$doWork$2) create(coroutineScope, dVar)).invokeSuspend(x0.f87415a);
    }
}
