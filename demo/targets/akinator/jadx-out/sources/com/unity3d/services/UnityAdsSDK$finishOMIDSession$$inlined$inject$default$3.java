...
public final class UnityAdsSDK$finishOMIDSession$$inlined$inject$default$3 extends f0 implements a {
    ...
    public final OmFinishSession invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, c1.getOrCreateKotlinClass(OmFinishSession.class));
    }
}
