...
public final class ProductBuilderBridge extends GenericBridge {
    ...
    public ProductBuilderBridge(Object builderInstance) {
        super(p1.mapOf(e0.to(SET_PRODUCT_ID_METHOD, new Class[]{String.class}), e0.to(SET_PRODUCT_TYPE_METHOD, new Class[]{String.class}), e0.to(BUILD_METHOD, new Class[0])));
    ...
    public final ProductBuilderBridge setProductId(String productId) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        kotlin.jvm.internal.e0.checkNotNullParameter(productId, "productId");
        Object objCallNonVoidMethod = callNonVoidMethod(SET_PRODUCT_ID_METHOD, this.builderInstance, productId);
        kotlin.jvm.internal.e0.checkNotNullExpressionValue(objCallNonVoidMethod, "callNonVoidMethod(SET_PR…ilderInstance, productId)");
        this.builderInstance = objCallNonVoidMethod;
        return this;
    }

    public final ProductBuilderBridge setProductType(String productType) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
