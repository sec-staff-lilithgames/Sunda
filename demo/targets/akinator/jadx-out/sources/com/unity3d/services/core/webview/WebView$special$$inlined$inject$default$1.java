...
public final class WebView$special$$inlined$inject$default$1 extends f0 implements kv.a {
    ...
    public final SDKMetricsSender invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, c1.getOrCreateKotlinClass(SDKMetricsSender.class));
    }
}
