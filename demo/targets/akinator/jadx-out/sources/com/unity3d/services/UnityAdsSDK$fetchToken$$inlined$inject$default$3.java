...
public final class UnityAdsSDK$fetchToken$$inlined$inject$default$3 extends f0 implements a {
    ...
    public final GetInitializationState invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, c1.getOrCreateKotlinClass(GetInitializationState.class));
    }
}
