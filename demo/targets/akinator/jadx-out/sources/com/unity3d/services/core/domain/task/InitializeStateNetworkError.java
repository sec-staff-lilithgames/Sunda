...
public final class InitializeStateNetworkError extends MetricTask<Params, x0> implements IConnectivityListener {
    private int connectedEventThreshold;
    private d<? super x0> continuation;
    ...
    public final void startListening(d<? super x0> dVar) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    public /* bridge */ /* synthetic */ Object mo3512doWorkgIAlus(BaseParams baseParams, d dVar) {
        return m3527doWorkgIAlus((Params) baseParams, (d<? super z>) dVar);
    }
    ...
    public void onConnected() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        if (shouldHandleConnectedEvent()) {
            d<? super x0> dVar = this.continuation;
            if (dVar != null) {
                int i10 = z.f87419c;
    ...
    */
    public java.lang.Object m3527doWorkgIAlus(com.unity3d.services.core.domain.task.InitializeStateNetworkError.Params r6, zu.d<? super tu.z> r7) {
        /*
            r5 = this;
        ...
        L49:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.domain.task.InitializeStateNetworkError.m3527doWorkgIAlus(com.unity3d.services.core.domain.task.InitializeStateNetworkError$Params, zu.d):java.lang.Object");
    }
}
