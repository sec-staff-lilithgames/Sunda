...
public final class UnityAdsSDK$initialize$$inlined$inject$default$3 extends f0 implements a {
    ...
    public final InitializeSDK invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, c1.getOrCreateKotlinClass(InitializeSDK.class));
    }
}
