...
public final class UnityAdsSDK$fetchToken$$inlined$inject$default$1 extends f0 implements a {
    ...
    public final TokenNumberProvider invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, c1.getOrCreateKotlinClass(TokenNumberProvider.class));
    }
}
