...
public final class UnityAdsSDK$initialize$$inlined$inject$default$1 extends f0 implements a {
    ...
    public final ShouldAllowInitialization invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, c1.getOrCreateKotlinClass(ShouldAllowInitialization.class));
    }
}
