...
public final class UnityAdsSDK$getToken$$inlined$inject$default$1 extends f0 implements a {
    ...
    public final GetGameId invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, c1.getOrCreateKotlinClass(GetGameId.class));
    }
}
