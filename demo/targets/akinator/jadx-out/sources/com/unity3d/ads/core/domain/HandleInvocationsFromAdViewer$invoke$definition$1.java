...
public final class HandleInvocationsFromAdViewer$invoke$definition$1 extends f0 implements kv.a {
    ...
    public final ExposedFunction invoke() {
        return CommonAdViewerExposedFunctionsKt.m3507getAdContextyLuu4LI((AndroidGetAdPlayerContext) this.this$0.getServiceProvider().getRegistry().getService("", c1.getOrCreateKotlinClass(AndroidGetAdPlayerContext.class)), this.$adDataObject, this.$impressionConfigObject, this.$adDataRefreshTokenObject, (IsOMActivated) this.this$0.getServiceProvider().getRegistry().getService("", c1.getOrCreateKotlinClass(IsOMActivated.class)), this.$adObject);
    }
}
