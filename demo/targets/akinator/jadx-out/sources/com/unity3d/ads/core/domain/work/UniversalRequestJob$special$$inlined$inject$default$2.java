...
public final class UniversalRequestJob$special$$inlined$inject$default$2 extends f0 implements a {
    ...
    public final UniversalRequestDataSource invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, c1.getOrCreateKotlinClass(UniversalRequestDataSource.class));
    }
}
