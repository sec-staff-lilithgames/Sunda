...
public final class OperativeEventObserver {
    ...
    public static final class AnonymousClass2 extends n implements p {
        ...
        public static final class C05442 extends n implements p {
            /* synthetic */ Object L$0;
            int label;
            final /* synthetic */ OperativeEventObserver this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C05442(OperativeEventObserver operativeEventObserver, d<? super C05442> dVar) {
                super(2, dVar);
            ...
            public final d<x0> create(Object obj, d<?> dVar) {
                C05442 c05442 = new C05442(this.this$0, dVar);
                c05442.L$0 = obj;
                return c05442;
            }

            @Override // kv.p
            public final Object invoke(OperativeEventRequestOuterClass.OperativeEventRequest operativeEventRequest, d<? super x0> dVar) {
                return ((C05442) create(operativeEventRequest, dVar)).invokeSuspend(x0.f87415a);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i10 != 1) {
                    ...
                    b1 b1VarBuild = ((f0.a) ((f0.a) ((f0.a) new f0.a((Class<? extends b0>) OperativeEventJob.class).setConstraints(fVarBuild)).setInputData(universalRequestWorkerData.invoke())).addTag(BackgroundWorker.TAG)).build();
                ...
                if (universalRequestDataSource.set(strC, byteString, this) != coroutine_suspended) {
                    ...
                    b1 b1VarBuild2 = ((f0.a) ((f0.a) ((f0.a) new f0.a((Class<? extends b0>) OperativeEventJob.class).setConstraints(fVarBuild2)).setInputData(universalRequestWorkerData2.invoke())).addTag(BackgroundWorker.TAG)).build();
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            FlowKt.launchIn(FlowKt.onEach(OperativeEventObserver.this.operativeEventRepository.getOperativeEvents(), new C05442(OperativeEventObserver.this, null)), CoroutineScopeKt.CoroutineScope(OperativeEventObserver.this.defaultDispatcher));
            return x0Var;
        }
