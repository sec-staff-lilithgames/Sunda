...
public final class AndroidGetInitializationData implements GetInitializationData {
    ...
    /* compiled from: r8-map-id-329fa88356c9e071bedcd87e8cbc16a4cb0c028932e63902b8210957806638ae */
    @f(c = "com.unity3d.ads.core.domain.AndroidGetInitializationData", f = "AndroidGetInitializationData.kt", i = {0, 0}, l = {10, 11}, m = "invoke", n = {"this", "$this$invoke_u24lambda_u240"}, s = {"L$0", "L$2"})
    ...
    public AndroidGetInitializationData(GetInitializationRequestPayload getInitializeRequestPayload, GetUniversalRequestSharedData getUniversalRequestSharedData) {
        e0.checkNotNullParameter(getInitializeRequestPayload, "getInitializeRequestPayload");
    ...
    */
    public java.lang.Object invoke(zu.d<? super gatewayprotocol.v1.InitializationDataOuterClass.InitializationData> r9) {
        /*
            r8 = this;
        ...
        L53:
            ...
            kotlin.jvm.internal.e0.checkNotNullExpressionValue(r2, r5)
        ...
        L96:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unity3d.ads.core.domain.AndroidGetInitializationData.invoke(zu.d):java.lang.Object");
    }
}
