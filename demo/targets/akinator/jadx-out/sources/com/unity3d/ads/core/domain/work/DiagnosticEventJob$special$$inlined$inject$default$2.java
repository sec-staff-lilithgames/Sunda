...
public final class DiagnosticEventJob$special$$inlined$inject$default$2 extends f0 implements a {
    ...
    public final DiagnosticEventRequestWorkModifier invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, c1.getOrCreateKotlinClass(DiagnosticEventRequestWorkModifier.class));
    }
}
