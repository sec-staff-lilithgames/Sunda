...
public final class WebViewConfigurationStoreSerializer implements h2 {
    ...
    @Override // k4.h2
    public Object readFrom(InputStream inputStream, d<? super WebviewConfigurationStore.WebViewConfigurationStore> dVar) throws IOException {
        try {
    ...
    public /* bridge */ /* synthetic */ Object writeTo(Object obj, OutputStream outputStream, d dVar) {
        return writeTo((WebviewConfigurationStore.WebViewConfigurationStore) obj, outputStream, (d<? super x0>) dVar);
    }
    ...
    public Object writeTo(WebviewConfigurationStore.WebViewConfigurationStore webViewConfigurationStore, OutputStream outputStream, d<? super x0> dVar) throws IOException {
