...
public final class UniversalRequestJob$special$$inlined$inject$default$1 extends f0 implements a {
    ...
    public final UniversalRequestEventSender invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, c1.getOrCreateKotlinClass(UniversalRequestEventSender.class));
    }
}
