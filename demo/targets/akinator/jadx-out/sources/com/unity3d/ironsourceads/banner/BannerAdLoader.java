...
public final class BannerAdLoader {
    ...
    private static final Executor f50596a = V7.f35633a.c();
    ...
    public static final void loadAd(BannerAdRequest adRequest, BannerAdLoaderListener listener) {
        ...
        INSTANCE.internalLoadAd$mediationsdk_release(f50596a, new C3226g3(adRequest, listener, C3306kc.f37095e.a(IronSource.a.BANNER), null, 8, null));
    }
