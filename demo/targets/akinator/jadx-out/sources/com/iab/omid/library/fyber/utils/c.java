...
public class c {
    ...
    private static WindowManager f30696a;

    /* renamed from: b, reason: collision with root package name */
    private static String[] f30697b = {"x", "y", "width", "height"};

    /* renamed from: c, reason: collision with root package name */
    static float f30698c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) throws JSONException {
        ...
        try {
            jSONObject.put("width", bVarA.f30700a);
            jSONObject.put("height", bVarA.f30701b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f30696a != null) {
            ...
            f30696a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f30698c = context.getResources().getDisplayMetrics().density;
            f30696a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0183a c0183a) throws JSONException {
        com.iab.omid.library.fyber.internal.e eVarA = c0183a.a();
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f30699a[outputDeviceStatus.ordinal()] == 1;
    }
