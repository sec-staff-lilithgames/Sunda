...
public class c {
    ...
    private static WindowManager f30967a;

    /* renamed from: b, reason: collision with root package name */
    private static String[] f30968b = {"x", "y", "width", "height"};

    /* renamed from: c, reason: collision with root package name */
    static float f30969c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) throws JSONException {
        ...
        try {
            jSONObject.put("width", bVarA.f30971a);
            jSONObject.put("height", bVarA.f30972b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f30967a != null) {
            ...
            f30967a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f30969c = context.getResources().getDisplayMetrics().density;
            f30967a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0191a c0191a) throws JSONException {
        com.iab.omid.library.ironsrc.internal.e eVarA = c0191a.a();
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f30970a[outputDeviceStatus.ordinal()] == 1;
    }
