...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.bytedance2.weakreference.b f30544b;

    /* renamed from: c, reason: collision with root package name */
    private AdEvents f30545c;

    /* renamed from: d, reason: collision with root package name */
    private MediaEvents f30546d;
    ...
    public AdSessionStatePublisher(String str) {
        a();
        this.f30543a = str;
        this.f30544b = new com.iab.omid.library.bytedance2.weakreference.b(null);
    }

    public void a() {
        this.f30548f = f.b();
        this.f30547e = a.AD_STATE_IDLE;
    }
    ...
    public void f() {
        h.a().a(getWebView(), this.f30543a);
    }

    public void g() {
        h.a().b(getWebView(), this.f30543a);
    }

    public WebView getWebView() {
        return this.f30544b.get();
    }
    ...
    public void a(float f10) {
        h.a().a(getWebView(), this.f30543a, f10);
    }

    public void b(String str, long j10) {
        if (j10 >= this.f30548f) {
            this.f30547e = a.AD_STATE_VISIBLE;
            h.a().a(getWebView(), this.f30543a, str);
        }
    }

    public void a(WebView webView) {
        this.f30544b = new com.iab.omid.library.bytedance2.weakreference.b(webView);
    }

    public void a(AdEvents adEvents) {
        this.f30545c = adEvents;
    }

    public void a(AdSessionConfiguration adSessionConfiguration) {
        h.a().a(getWebView(), this.f30543a, adSessionConfiguration.toJsonObject());
    }

    public void a(ErrorType errorType, String str) {
        h.a().a(getWebView(), this.f30543a, errorType, str);
    }
    ...
    public void a(String str, JSONObject jSONObject) {
        h.a().a(getWebView(), this.f30543a, str, jSONObject);
    }
    ...
    public void a(JSONObject jSONObject) {
        h.a().b(getWebView(), this.f30543a, jSONObject);
    }

    public void a(boolean z10) {
        if (e()) {
            h.a().b(getWebView(), this.f30543a, z10 ? "foregrounded" : "backgrounded");
        }
    }
