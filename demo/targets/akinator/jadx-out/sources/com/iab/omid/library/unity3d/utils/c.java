...
public class c {
    ...
    private static WindowManager f31348a;

    /* renamed from: b, reason: collision with root package name */
    private static String[] f31349b = {"x", "y", "width", "height"};

    /* renamed from: c, reason: collision with root package name */
    static float f31350c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) throws JSONException {
        ...
        try {
            jSONObject.put("width", bVarA.f31352a);
            jSONObject.put("height", bVarA.f31353b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f31348a != null) {
            ...
            f31348a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f31350c = context.getResources().getDisplayMetrics().density;
            f31348a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0202a c0202a) throws JSONException {
        com.iab.omid.library.unity3d.internal.e eVarA = c0202a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0202a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f31351a[outputDeviceStatus.ordinal()] == 1;
    }
