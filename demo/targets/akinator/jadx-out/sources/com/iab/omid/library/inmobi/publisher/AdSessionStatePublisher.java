...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.inmobi.weakreference.b f30815b;

    /* renamed from: c, reason: collision with root package name */
    private AdEvents f30816c;

    /* renamed from: d, reason: collision with root package name */
    private MediaEvents f30817d;
    ...
    public AdSessionStatePublisher(String str) {
        a();
        this.f30814a = str;
        this.f30815b = new com.iab.omid.library.inmobi.weakreference.b(null);
    }

    public void a() {
        this.f30819f = f.b();
        this.f30818e = a.AD_STATE_IDLE;
    }
    ...
    public boolean e() {
        return this.f30815b.get() != null;
    }

    public void f() {
        h.a().a(getWebView(), this.f30814a);
    }

    public void g() {
        h.a().b(getWebView(), this.f30814a);
    }

    public WebView getWebView() {
        return this.f30815b.get();
    }
    ...
    public void a(float f10) {
        h.a().a(getWebView(), this.f30814a, f10);
    }

    public void b(String str, long j10) {
        if (j10 >= this.f30819f) {
            this.f30818e = a.AD_STATE_VISIBLE;
            h.a().b(getWebView(), this.f30814a, str);
        }
    }

    public void a(WebView webView) {
        this.f30815b = new com.iab.omid.library.inmobi.weakreference.b(webView);
    }

    public void b(boolean z10) {
        if (e()) {
            h.a().a(getWebView(), this.f30814a, z10 ? "locked" : "unlocked");
        }
    }

    public void a(AdEvents adEvents) {
        this.f30816c = adEvents;
    }

    public void a(AdSessionConfiguration adSessionConfiguration) {
        h.a().a(getWebView(), this.f30814a, adSessionConfiguration.toJsonObject());
    }

    public void a(ErrorType errorType, String str) {
        h.a().a(getWebView(), this.f30814a, errorType, str);
    }
    ...
    public void a(com.iab.omid.library.inmobi.adsession.a aVar, AdSessionContext adSessionContext, JSONObject jSONObject) throws JSONException {
        String strC = aVar.c();
    ...
    public void a(String str, JSONObject jSONObject) {
        h.a().a(getWebView(), this.f30814a, str, jSONObject);
    }
    ...
    public void a(JSONObject jSONObject) {
        h.a().b(getWebView(), this.f30814a, jSONObject);
    }

    public void a(boolean z10) {
        if (e()) {
            h.a().c(getWebView(), this.f30814a, z10 ? SFPXhf.gxkHPT : "backgrounded");
        }
    }
}
