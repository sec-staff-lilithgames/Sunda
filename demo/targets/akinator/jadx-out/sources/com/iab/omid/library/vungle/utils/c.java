...
public class c {
    ...
    private static WindowManager f31482a;

    /* renamed from: b, reason: collision with root package name */
    private static String[] f31483b = {"x", "y", "width", "height"};

    /* renamed from: c, reason: collision with root package name */
    static float f31484c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) throws JSONException {
        ...
        try {
            jSONObject.put("width", bVarA.f31486a);
            jSONObject.put("height", bVarA.f31487b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f31482a != null) {
            ...
            f31482a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f31484c = context.getResources().getDisplayMetrics().density;
            f31482a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0206a c0206a) throws JSONException {
        com.iab.omid.library.vungle.internal.e eVarA = c0206a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0206a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f31485a[outputDeviceStatus.ordinal()] == 1;
    }
