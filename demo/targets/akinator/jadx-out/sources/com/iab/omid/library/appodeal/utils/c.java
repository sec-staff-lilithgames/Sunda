...
public class c {
    ...
    private static WindowManager f30431a;

    /* renamed from: b, reason: collision with root package name */
    private static String[] f30432b = {"x", "y", "width", "height"};

    /* renamed from: c, reason: collision with root package name */
    static float f30433c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) throws JSONException {
        ...
        try {
            jSONObject.put("width", bVarA.f30435a);
            jSONObject.put("height", bVarA.f30436b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f30431a != null) {
            ...
            f30431a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f30433c = context.getResources().getDisplayMetrics().density;
            f30431a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0175a c0175a) throws JSONException {
        com.iab.omid.library.appodeal.internal.e eVarA = c0175a.a();
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f30434a[outputDeviceStatus.ordinal()] == 1;
    }
