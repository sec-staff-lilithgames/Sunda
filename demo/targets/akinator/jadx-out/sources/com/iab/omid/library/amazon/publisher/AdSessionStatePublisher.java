...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.amazon.weakreference.b f30144b;

    /* renamed from: c, reason: collision with root package name */
    private AdEvents f30145c;

    /* renamed from: d, reason: collision with root package name */
    private MediaEvents f30146d;
    ...
    public AdSessionStatePublisher(String str) {
        a();
        this.f30143a = str;
        this.f30144b = new com.iab.omid.library.amazon.weakreference.b(null);
    }

    public void a() {
        this.f30148f = f.b();
        this.f30147e = a.AD_STATE_IDLE;
    }
    ...
    public boolean e() {
        return this.f30144b.get() != null;
    }

    public void f() {
        h.a().a(getWebView(), this.f30143a);
    }

    public void g() {
        h.a().b(getWebView(), this.f30143a);
    }

    public WebView getWebView() {
        return this.f30144b.get();
    }
    ...
    public void a(float f10) {
        h.a().a(getWebView(), this.f30143a, f10);
    }

    public void b(String str, long j10) {
        if (j10 >= this.f30148f) {
            this.f30147e = a.AD_STATE_VISIBLE;
            h.a().a(getWebView(), this.f30143a, str);
        }
    }

    public void a(WebView webView) {
        this.f30144b = new com.iab.omid.library.amazon.weakreference.b(webView);
    }

    public void a(AdEvents adEvents) {
        this.f30145c = adEvents;
    }

    public void a(AdSessionConfiguration adSessionConfiguration) {
        h.a().a(getWebView(), this.f30143a, adSessionConfiguration.toJsonObject());
    }

    public void a(ErrorType errorType, String str) {
        h.a().a(getWebView(), this.f30143a, errorType, str);
    }
    ...
    public void a(com.iab.omid.library.amazon.adsession.a aVar, AdSessionContext adSessionContext, JSONObject jSONObject) throws JSONException {
        String adSessionId = aVar.getAdSessionId();
        JSONObject jSONObject2 = new JSONObject();
        c.a(jSONObject2, "environment", MBridgeConstans.DYNAMIC_VIEW_WX_APP);
        c.a(jSONObject2, "adSessionType", adSessionContext.getAdSessionContextType());
        c.a(jSONObject2, "deviceInfo", com.iab.omid.library.amazon.utils.b.d());
    ...
    public void a(String str, JSONObject jSONObject) {
        h.a().a(getWebView(), this.f30143a, str, jSONObject);
    }
    ...
    public void a(JSONObject jSONObject) {
        h.a().b(getWebView(), this.f30143a, jSONObject);
    }

    public void a(boolean z10) {
        if (e()) {
            h.a().b(getWebView(), this.f30143a, z10 ? "foregrounded" : "backgrounded");
        }
    }
