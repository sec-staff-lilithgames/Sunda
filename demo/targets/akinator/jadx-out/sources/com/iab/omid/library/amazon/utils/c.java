...
public class c {
    ...
    private static WindowManager f30161a;

    /* renamed from: b, reason: collision with root package name */
    private static String[] f30162b = {"x", "y", "width", "height"};

    /* renamed from: c, reason: collision with root package name */
    static float f30163c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) throws JSONException {
        ...
        try {
            jSONObject.put("width", bVarA.f30165a);
            jSONObject.put("height", bVarA.f30166b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f30161a != null) {
            ...
            f30161a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f30163c = context.getResources().getDisplayMetrics().density;
            f30161a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0167a c0167a) throws JSONException {
        com.iab.omid.library.amazon.internal.e eVarA = c0167a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0167a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f30164a[outputDeviceStatus.ordinal()] == 1;
    }
