...
public class c {
    ...
    private static WindowManager f30295a;

    /* renamed from: b, reason: collision with root package name */
    private static String[] f30296b = {"x", "y", "width", "height"};

    /* renamed from: c, reason: collision with root package name */
    static float f30297c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) throws JSONException {
        ...
        try {
            jSONObject.put("width", bVarA.f30299a);
            jSONObject.put("height", bVarA.f30300b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f30295a != null) {
            ...
            f30295a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f30297c = context.getResources().getDisplayMetrics().density;
            f30295a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0171a c0171a) throws JSONException {
        com.iab.omid.library.applovin.internal.e eVarA = c0171a.a();
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f30298a[outputDeviceStatus.ordinal()] == 1;
    }
