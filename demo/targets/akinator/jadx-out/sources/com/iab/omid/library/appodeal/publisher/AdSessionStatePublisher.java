...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.appodeal.weakreference.b f30414b;

    /* renamed from: c, reason: collision with root package name */
    private AdEvents f30415c;

    /* renamed from: d, reason: collision with root package name */
    private MediaEvents f30416d;

    /* renamed from: e, reason: collision with root package name */
    private a f30417e;

    /* renamed from: f, reason: collision with root package name */
    private long f30418f;
    ...
    public AdSessionStatePublisher(String str) {
        a();
        this.f30413a = str;
        this.f30414b = new com.iab.omid.library.appodeal.weakreference.b(null);
    }

    public void a() {
        this.f30418f = f.b();
        this.f30417e = a.AD_STATE_IDLE;
    }
    ...
    public boolean e() {
        return this.f30414b.get() != null;
    }

    public void f() {
        h.a().a(getWebView(), this.f30413a);
    }

    public void g() {
        h.a().b(getWebView(), this.f30413a);
    }
    ...
    public void a(float f10) {
        h.a().a(getWebView(), this.f30413a, f10);
    }

    public void b(String str, long j10) {
        if (j10 >= this.f30418f) {
            this.f30417e = a.AD_STATE_VISIBLE;
            h.a().b(getWebView(), this.f30413a, str);
        }
    }

    public void a(WebView webView) {
        this.f30414b = new com.iab.omid.library.appodeal.weakreference.b(webView);
    }

    public void b(boolean z10) {
        if (e()) {
            h.a().a(getWebView(), this.f30413a, z10 ? "locked" : "unlocked");
        }
    }

    public void a(AdEvents adEvents) {
        this.f30415c = adEvents;
    }

    public void a(AdSessionConfiguration adSessionConfiguration) {
        h.a().a(getWebView(), this.f30413a, adSessionConfiguration.toJsonObject());
    }

    public void a(ErrorType errorType, String str) {
        h.a().a(getWebView(), this.f30413a, errorType, str);
    }
    ...
    public void a(com.iab.omid.library.appodeal.adsession.a aVar, AdSessionContext adSessionContext, JSONObject jSONObject) throws JSONException {
        String strC = aVar.c();
    ...
    public void a(String str, JSONObject jSONObject) {
        h.a().a(getWebView(), this.f30413a, str, jSONObject);
    }
    ...
    public void a(JSONObject jSONObject) {
        h.a().b(getWebView(), this.f30413a, jSONObject);
    }

    public void a(boolean z10) {
        if (e()) {
            h.a().c(getWebView(), this.f30413a, z10 ? "foregrounded" : "backgrounded");
        }
    }
