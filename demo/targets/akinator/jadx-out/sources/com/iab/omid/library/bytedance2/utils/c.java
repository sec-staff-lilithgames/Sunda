...
public class c {
    ...
    private static WindowManager f30561a;

    /* renamed from: b, reason: collision with root package name */
    private static String[] f30562b = {"x", "y", "width", "height"};

    /* renamed from: c, reason: collision with root package name */
    static float f30563c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) throws JSONException {
        ...
        try {
            jSONObject.put("width", bVarA.f30565a);
            jSONObject.put("height", bVarA.f30566b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f30561a != null) {
            ...
            f30561a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f30563c = context.getResources().getDisplayMetrics().density;
            f30561a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0179a c0179a) throws JSONException {
        com.iab.omid.library.bytedance2.internal.e eVarA = c0179a.a();
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f30564a[outputDeviceStatus.ordinal()] == 1;
    }
