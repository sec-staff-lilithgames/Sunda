...
public class c {
    ...
    private static WindowManager f30832a;

    /* renamed from: b, reason: collision with root package name */
    private static String[] f30833b = {"x", "y", "width", "height"};

    /* renamed from: c, reason: collision with root package name */
    static float f30834c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) throws JSONException {
        ...
        try {
            jSONObject.put("width", bVarA.f30836a);
            jSONObject.put("height", bVarA.f30837b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f30832a != null) {
            ...
            f30832a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f30834c = context.getResources().getDisplayMetrics().density;
            f30832a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0187a c0187a) throws JSONException {
        com.iab.omid.library.inmobi.internal.e eVarA = c0187a.a();
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f30835a[outputDeviceStatus.ordinal()] == 1;
    }
