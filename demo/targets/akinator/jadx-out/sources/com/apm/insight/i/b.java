...
public final class b implements c {
    ...
    private synchronized void b(final long j10, final Thread thread, final Throwable th2, final String str, final String str2, final boolean z10) {
        final File file = new File(j.a(this.f13058a), str);
            ...
            public final com.apm.insight.entity.a a(int i10, com.apm.insight.entity.a aVar) throws JSONException {
                ...
                if (i10 == 0) {
                    ...
                    if (i10 == 1) {
                        ...
                        aVar.a("main_process", Boolean.valueOf(com.apm.insight.l.a.b(b.this.f13058a)));
                    ...
                    if (i10 == 2) {
                        if (zC) {
                            com.apm.insight.l.a.a(b.this.f13058a, aVar.c());
                        }
                        aVar.a("launch_did", (Object) a.a(b.this.f13058a));
                        if (e.x()) {
