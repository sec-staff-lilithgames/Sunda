...
public final class Cache implements Closeable, Flushable {
    ...
    public static final class CacheResponseBody extends ResponseBody {
        ...
        public CacheResponseBody(DiskLruCache.Snapshot snapshot, String str, String str2) {
            e0.checkNotNullParameter(snapshot, "snapshot");
    ...
    public static final class Companion {
        ...
        private final Set<String> varyFields(Headers headers) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                if (k0.equals("Vary", headers.name(i10), true)) {
                    String strValue = headers.value(i10);
                    if (treeSet == null) {
                        treeSet = new TreeSet(k0.getCASE_INSENSITIVE_ORDER(g1.f71834a));
                    }
                    Iterator it = n0.split$default((CharSequence) strValue, new char[]{AbstractJsonLexerKt.COMMA}, false, 0, 6, (Object) null).iterator();
                    while (it.hasNext()) {
                        treeSet.add(n0.trim((String) it.next()).toString());
                    }
                }
            }
        ...
        public final Headers varyHeaders(Response response) {
            ...
            e0.checkNotNull(responseNetworkResponse);
        ...
        public final boolean varyMatches(Response cachedResponse, Headers cachedRequest, Request newRequest) {
            ...
            e0.checkNotNullParameter(cachedRequest, "cachedRequest");
            e0.checkNotNullParameter(newRequest, "newRequest");
            ...
            for (String str : setVaryFields) {
                if (!e0.areEqual(cachedRequest.values(str), newRequest.headers(str))) {
                    return false;
                }
            }
            return true;
    ...
    public static final class AnonymousClass1 implements Iterator<String>, c {
    ...
    public final CacheRequest put$okhttp(Response response) {
        ...
        if (!e0.areEqual(strMethod, C3271ic.f36943a)) {
            return null;
        }
    ...
    public final synchronized void trackResponse$okhttp(CacheStrategy cacheStrategy) {
        try {
            e0.checkNotNullParameter(cacheStrategy, "cacheStrategy");
            this.requestCount++;
    ...
    public final void update$okhttp(Response cached, Response network) {
        ...
        e0.checkNotNullParameter(cached, "cached");
        e0.checkNotNullParameter(network, "network");
        Entry entry = new Entry(network);
        ResponseBody responseBodyBody = cached.body();
        e0.checkNotNull(responseBodyBody, "null cannot be cast to non-null type okhttp3.Cache.CacheResponseBody");
        try {
    ...
    public static final class Entry {
        ...
        public Entry(Source rawSource) throws IOException {
            e0.checkNotNullParameter(rawSource, "rawSource");
            try {
                ...
                d.closeFinally(rawSource, null);
            } catch (Throwable th2) {
                try {
                    throw th2;
                } catch (Throwable th3) {
                    d.closeFinally(rawSource, th2);
                    throw th3;
                }
            }
        }
        ...
        private final boolean isHttps() {
            return e0.areEqual(this.url.scheme(), HttpRequest.DEFAULT_SCHEME);
        }
        ...
        private final void writeCertList(BufferedSink bufferedSink, List<? extends Certificate> list) throws IOException, CertificateEncodingException {
            try {
                ...
                while (it.hasNext()) {
                    ...
                    e0.checkNotNullExpressionValue(bytes, "bytes");
        ...
        public final boolean matches(Request request, Response response) {
            e0.checkNotNullParameter(request, "request");
            e0.checkNotNullParameter(response, "response");
            return e0.areEqual(this.url, request.url()) && e0.areEqual(this.requestMethod, request.method()) && Cache.Companion.varyMatches(response, this.varyHeaders, request);
        }
