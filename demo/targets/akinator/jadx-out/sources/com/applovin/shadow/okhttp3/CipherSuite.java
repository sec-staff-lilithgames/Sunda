...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        private final String secondaryName(String str) {
            if (k0.startsWith$default(str, "TLS_", false, 2, null)) {
            ...
            if (!k0.startsWith$default(str, "SSL_", false, 2, null)) {
                return str;
            }
    ...
    public final String m237deprecated_javaName() {
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: com.applovin.shadow.okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(String a10, String b10) {
                ...
                for (int i10 = 4; i10 < iMin; i10++) {
                    ...
                    if (cCharAt != cCharAt2) {
                        return e0.compare((int) cCharAt, (int) cCharAt2) < 0 ? -1 : 1;
                    }
                }
        ...
        TLS_RSA_WITH_CAMELLIA_128_CBC_SHA = companion.init(DwaEpyvxz.uSQ, 65);
