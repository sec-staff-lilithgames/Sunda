...
public final class Utf8 {
    ...
    public static final int process2Utf8Bytes(byte[] bArr, int i10, int i11, l yield) {
        Integer numValueOf = Integer.valueOf(REPLACEMENT_CODE_POINT);
        e0.checkNotNullParameter(bArr, "<this>");
        e0.checkNotNullParameter(yield, "yield");
        int i12 = i10 + 1;
        if (i11 <= i12) {
    ...
    public static final int process3Utf8Bytes(byte[] bArr, int i10, int i11, l yield) {
        Integer numValueOf = Integer.valueOf(REPLACEMENT_CODE_POINT);
        e0.checkNotNullParameter(bArr, "<this>");
        e0.checkNotNullParameter(yield, "yield");
        int i12 = i10 + 2;
    ...
    public static final int process4Utf8Bytes(byte[] bArr, int i10, int i11, l yield) {
        Integer numValueOf = Integer.valueOf(REPLACEMENT_CODE_POINT);
        e0.checkNotNullParameter(bArr, "<this>");
        e0.checkNotNullParameter(yield, "yield");
        int i12 = i10 + 3;
    ...
    */
    public static final void processUtf16Chars(byte[] r12, int r13, int r14, kv.l r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.applovin.shadow.okio.Utf8.processUtf16Chars(byte[], int, int, kv.l):void");
    }

    public static final void processUtf8Bytes(String str, int i10, int i11, l yield) {
        int i12;
        char cCharAt;
        ...
        while (i10 < i11) {
            ...
            if (e0.compare((int) cCharAt2, 128) < 0) {
                ...
                i10++;
                while (i10 < i11 && e0.compare((int) str.charAt(i10), 128) < 0) {
                    yield.invoke(Byte.valueOf((byte) str.charAt(i10)));
                    i10++;
                }
            } else {
                if (e0.compare((int) cCharAt2, 2048) < 0) {
                    ...
                    yield.invoke(Byte.valueOf((byte) ((cCharAt2 & '?') | 128)));
                } else if (e0.compare((int) cCharAt2, 56319) > 0 || i11 <= (i12 = i10 + 1) || 56320 > (cCharAt = str.charAt(i12)) || cCharAt >= 57344) {
    ...
    */
    public static final void processUtf8CodePoints(byte[] r11, int r12, int r13, kv.l r14) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.applovin.shadow.okio.Utf8.processUtf8CodePoints(byte[], int, int, kv.l):void");
    }
