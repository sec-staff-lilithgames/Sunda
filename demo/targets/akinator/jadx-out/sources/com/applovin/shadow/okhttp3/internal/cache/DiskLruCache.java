...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    public static final x LEGAL_KEY_PATTERN = new x("[a-z0-9_-]{1,120}");
    ...
    public final class Editor {
        ...
        public final void abort() throws IOException {
            ...
            synchronized (diskLruCache) {
                try {
                    ...
                    if (e0.areEqual(this.entry.getCurrentEditor$okhttp(), this)) {
        ...
        public final Sink newSink(int i10) {
            ...
            synchronized (diskLruCache) {
                ...
                try {
                    return new FaultHidingSink(diskLruCache.getFileSystem$okhttp().sink(this.entry.getDirtyFiles$okhttp().get(i10)), new DiskLruCache$Editor$newSink$1$1(diskLruCache, this));
        ...
        public final Source newSource(int i10) {
            ...
            synchronized (diskLruCache) {
                ...
                Source source = null;
                if (!this.entry.getReadable$okhttp() || !e0.areEqual(this.entry.getCurrentEditor$okhttp(), this) || this.entry.getZombie$okhttp()) {
                    return null;
                }
                try {
    ...
    public static final class AnonymousClass1 implements Iterator<Snapshot>, c {
        ...
        public AnonymousClass1() {
            ...
            e0.checkNotNullExpressionValue(it, "ArrayList(lruEntries.values).iterator()");
            this.delegate = it;
        }
    ...
    public DiskLruCache(FileSystem fileSystem, File directory, int i10, int i11, long j10, TaskRunner taskRunner) {
        ...
        final String strO = o2.o(new StringBuilder(), Util.okHttpName, " Cache");
        this.cleanupTask = new Task(strO) { // from class: com.applovin.shadow.okhttp3.internal.cache.DiskLruCache$cleanupTask$1
    ...
    private final void processJournal() throws IOException {
        ...
        while (it.hasNext()) {
            Entry next = it.next();
            e0.checkNotNullExpressionValue(next, "i.next()");
            Entry entry = next;
            int i10 = 0;
    ...
    private final void readJournal() throws IOException {
        ...
        try {
            ...
            if (!e0.areEqual(MAGIC, utf8LineStrict) || !e0.areEqual(VERSION_1, utf8LineStrict2) || !e0.areEqual(String.valueOf(this.appVersion), utf8LineStrict3) || !e0.areEqual(String.valueOf(this.valueCount), utf8LineStrict4) || utf8LineStrict5.length() > 0) {
    ...
    private final void readJournalLine(String str) throws IOException {
        ...
        if (iIndexOf$default == -1) {
            throw new IOException(b.k("unexpected journal line: ", str));
        }
        int i10 = iIndexOf$default + 1;
        int iIndexOf$default2 = n0.indexOf$default((CharSequence) str, ' ', i10, false, 4, (Object) null);
        ...
        if (iIndexOf$default2 != -1) {
            ...
            if (iIndexOf$default == str3.length() && k0.startsWith$default(str, str3, false, 2, null)) {
                ...
                List<String> listSplit$default = n0.split$default((CharSequence) strSubstring2, new char[]{' '}, false, 0, 6, (Object) null);
    ...
    private final boolean removeOldestEntry() throws IOException {
        for (Entry toEvict : this.lruEntries.values()) {
            if (!toEvict.getZombie$okhttp()) {
                e0.checkNotNullExpressionValue(toEvict, "toEvict");
    ...
    public synchronized void close() throws IOException {
        ...
        try {
            if (this.initialized && !this.closed) {
                ...
                e0.checkNotNullExpressionValue(collectionValues, "lruEntries.values");
    ...
    public final synchronized void evictAll() throws IOException {
        try {
            ...
            e0.checkNotNullExpressionValue(collectionValues, "lruEntries.values");
            for (Entry entry : (Entry[]) collectionValues.toArray(new Entry[0])) {
                e0.checkNotNullExpressionValue(entry, "entry");
    ...
    public final synchronized void rebuildJournal$okhttp() throws IOException {
        try {
            ...
            try {
                ...
                d.closeFinally(bufferedSinkBuffer, null);
                if (this.fileSystem.exists(this.journalFile)) {
