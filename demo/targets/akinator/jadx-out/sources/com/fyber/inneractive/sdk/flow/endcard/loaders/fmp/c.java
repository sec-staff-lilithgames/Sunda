...
public final class c implements f0 {
    ...
    public final com.fyber.inneractive.sdk.flow.endcard.loaders.listeners.a f23607a;

    /* renamed from: b, reason: collision with root package name */
    public final o f23608b;
    ...
    public final void a(Object obj, Exception exc, boolean z10) throws JSONException {
        ...
        if (str != null && exc == null) {
            ((p) this.f23608b.f()).f23627e = str.concat("<style>body {margin: 0px; background-color: rgba(0, 0, 0, 0.0);}</style>");
            ((p) this.f23608b.f()).f23617l = z10;
            ((p) this.f23608b.f()).b(this.f23607a);
            return;
        }
