...
public final class h extends p0 implements com.fyber.inneractive.sdk.dv.interstitial.a {
    ...
    public com.fyber.inneractive.sdk.external.g f23468w;

    /* renamed from: x, reason: collision with root package name */
    public boolean f23469x = false;
    ...
    public final void h() {
        ...
        if (this.f23469x || (eventsListener = this.f23532c) == null) {
            return;
        }
        this.f23469x = true;
    ...
    public final void onReward() {
        com.fyber.inneractive.sdk.external.g gVar = this.f23468w;
        if (gVar != null) {
            i0 i0Var = (i0) v.a(((s0) gVar.f23518a).mAdSpot);
