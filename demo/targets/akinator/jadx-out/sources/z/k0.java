...
public final class k0 extends q {
    ...
    public final int a(int i10) {
        ...
        while (true) {
            ...
            if ((((~j10) << 6) & j10 & (-9187201950435737472L)) != 0) {
                int iB = b(i12);
                if (this.f96853e == 0 && ((this.f96898a[iB >> 3] >> ((iB & 7) << 3)) & 255) != 254) {
                    adjustStorage$collection();
                    iB = b(i12);
                }
                this.f96901d++;
                int i23 = this.f96853e;
                long[] jArr2 = this.f96898a;
                int i24 = iB >> 3;
                long j14 = jArr2[i24];
                int i25 = (iB & 7) << 3;
                this.f96853e = i23 - (((j14 >> i25) & 255) == 128 ? i22 : 0);
                int i26 = this.f96900c;
    ...
    public final boolean add(int i10) {
        int i11 = this.f96901d;
        this.f96899b[a(i10)] = i10;
        return this.f96901d != i11;
    }

    public final boolean addAll(int[] elements) {
        kotlin.jvm.internal.e0.checkNotNullParameter(elements, "elements");
        int i10 = this.f96901d;
        plusAssign(elements);
        return i10 != this.f96901d;
    }

    public final void adjustStorage$collection() {
        if (this.f96900c > 8) {
            if (Long.compare(tu.o0.m7081constructorimpl(tu.o0.m7081constructorimpl(this.f96901d) * 32) ^ Long.MIN_VALUE, tu.o0.m7081constructorimpl(tu.o0.m7081constructorimpl(this.f96900c) * 25) ^ Long.MIN_VALUE) <= 0) {
                dropDeletes$collection();
                return;
            }
        }
        resizeStorage$collection(m1.nextCapacity(this.f96900c));
    }

    public final int b(int i10) {
        int i11 = this.f96900c;
        int i12 = i10 & i11;
        int i13 = 0;
        while (true) {
            long[] jArr = this.f96898a;
    ...
    public final void c(int i10) {
        ...
        this.f96853e = m1.loadedCapacity(getCapacity()) - this.f96901d;
        this.f96899b = new int[iMax];
    }
    ...
    */
    public final void minusAssign(int r14) {
        ...
        L6a:
            ...
            goto L13
        */
        throw new UnsupportedOperationException("Method not decompiled: z.k0.minusAssign(int):void");
    }
    ...
    */
    public final boolean remove(int r19) {
        ...
        L73:
            ...
            goto L16
        */
        throw new UnsupportedOperationException("Method not decompiled: z.k0.remove(int):boolean");
    }
    ...
    public final void resizeStorage$collection(int i10) {
        ...
        c(i10);
        long[] jArr2 = this.f96898a;
        int[] iArr2 = this.f96899b;
        int i12 = this.f96900c;
        for (int i13 = 0; i13 < i11; i13++) {
    ...
    public final int trim() {
        int i10 = this.f96900c;
        int iNormalizeCapacity = m1.normalizeCapacity(m1.unloadedCapacity(this.f96901d));
        if (iNormalizeCapacity >= i10) {
            return 0;
        }
        resizeStorage$collection(iNormalizeCapacity);
        return i10 - this.f96900c;
    }
    ...
    public final boolean addAll(q elements) {
        kotlin.jvm.internal.e0.checkNotNullParameter(elements, "elements");
        int i10 = this.f96901d;
        plusAssign(elements);
        return i10 != this.f96901d;
    ...
    public final boolean removeAll(q elements) {
        kotlin.jvm.internal.e0.checkNotNullParameter(elements, "elements");
        int i10 = this.f96901d;
        minusAssign(elements);
        return i10 != this.f96901d;
    ...
    public final void plusAssign(q elements) {
        kotlin.jvm.internal.e0.checkNotNullParameter(elements, "elements");
        int[] iArr = elements.f96899b;
        long[] jArr = elements.f96898a;
    ...
    public final void minusAssign(q elements) {
        kotlin.jvm.internal.e0.checkNotNullParameter(elements, "elements");
        int[] iArr = elements.f96899b;
        long[] jArr = elements.f96898a;
        int length = jArr.length - 2;
