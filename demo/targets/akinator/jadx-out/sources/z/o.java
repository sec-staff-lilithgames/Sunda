...
public abstract class o {
    ...
    public o(int i10, kotlin.jvm.internal.u uVar) {
        this.f96885a = i10 == 0 ? r.getEmptyIntArray() : new int[i10];
    }

    public static /* synthetic */ int binarySearch$default(o oVar, int i10, int i11, int i12, int i13, Object obj) {
        if (obj != null) {
        ...
        return oVar.binarySearch(i10, i11, i12);
    }
    ...
    public static /* synthetic */ String joinToString$default(o oVar, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, int i11, Object obj) {
        if (obj != null) {
        ...
        return oVar.joinToString(charSequence, charSequence2, charSequence6, i10, charSequence5);
    }

    public final boolean any() {
        return this.f96886b != 0;
    }
    ...
    public final boolean containsAll(o elements) {
        kotlin.jvm.internal.e0.checkNotNullParameter(elements, "elements");
        qv.m mVarUntil = qv.v.until(0, elements.f96886b);
    ...
    public final int elementAt(int i10) {
        ...
        return this.f96885a[i10];
    }

    public final int elementAtOrElse(int i10, kv.l defaultValue) {
        kotlin.jvm.internal.e0.checkNotNullParameter(defaultValue, "defaultValue");
        return (i10 < 0 || i10 >= this.f96886b) ? ((Number) defaultValue.invoke(Integer.valueOf(i10))).intValue() : this.f96885a[i10];
    }

    public boolean equals(Object obj) {
        if (obj instanceof o) {
            o oVar = (o) obj;
            int i10 = oVar.f96886b;
            int i11 = this.f96886b;
            if (i10 == i11) {
                int[] iArr = this.f96885a;
                int[] iArr2 = oVar.f96885a;
    ...
    public final int first() {
        if (this.f96886b == 0) {
            a0.d.throwNoSuchElementException("IntList is empty.");
        }
        return this.f96885a[0];
    }
    ...
    public final qv.m getIndices() {
        return qv.v.until(0, this.f96886b);
    }

    public final int getLastIndex() {
        return this.f96886b - 1;
    }
    ...
    public final int last() {
        ...
        return this.f96885a[this.f96886b - 1];
    }
    ...
    public final boolean reversedAny(kv.l predicate) {
        kotlin.jvm.internal.e0.checkNotNullParameter(predicate, "predicate");
        int[] iArr = this.f96885a;
        for (int i10 = this.f96886b - 1; -1 < i10; i10--) {
    ...
    public final int binarySearch(int i10, int i11, int i12) {
        if (i11 < 0 || i11 >= i12 || i12 > this.f96886b) {
            a0.d.throwIndexOutOfBoundsException("");
        }
        int i13 = i12 - 1;
        while (i11 <= i13) {
            int i14 = (i11 + i13) >>> 1;
            int i15 = this.f96885a[i14];
            if (i15 < i10) {
                i11 = i14 + 1;
            } else {
                if (i15 <= i10) {
    ...
    public final int first(kv.l predicate) {
        kotlin.jvm.internal.e0.checkNotNullParameter(predicate, "predicate");
        int[] iArr = this.f96885a;
        int i10 = this.f96886b;
        for (int i11 = 0; i11 < i10; i11++) {
    ...
    public static /* synthetic */ String joinToString$default(o oVar, CharSequence separator, CharSequence prefix, CharSequence postfix, int i10, CharSequence charSequence, kv.l lVar, int i11, Object obj) {
        if (obj == null) {
            if ((i11 & 1) != 0) {
                separator = ", ";
            }
            ...
            int[] iArr = oVar.f96885a;
            int i12 = oVar.f96886b;
            int i13 = 0;
            while (true) {
                if (i13 < i12) {
                    int i14 = iArr[i13];
                    ...
                    sbG.append((CharSequence) lVar.invoke(Integer.valueOf(i14)));
                    i13++;
                } else {
                    sbG.append(postfix);
                    break;
        ...
        throw new UnsupportedOperationException(yFkbx.kNkloiyu);
    }
    ...
    public final int last(kv.l predicate) {
        int i10;
        kotlin.jvm.internal.e0.checkNotNullParameter(predicate, "predicate");
        int[] iArr = this.f96885a;
        int i11 = this.f96886b;
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int i10, CharSequence charSequence, kv.l lVar) {
        ...
        while (true) {
            if (i12 < i11) {
                ...
                sbG.append((CharSequence) lVar.invoke(Integer.valueOf(i13)));
                i12++;
            } else {
                sbG.append(postfix);
                break;
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence charSequence, kv.l lVar) {
        ...
        while (true) {
            if (i11 < i10) {
                ...
                sbG.append((CharSequence) lVar.invoke(Integer.valueOf(i12)));
                i11++;
            } else {
                sbG.append(charSequence);
                break;
