...
public abstract class m {
    public static final v5 collectIsHoveredAsState(o oVar, p0.w wVar, int i10) {
        e0.checkNotNullParameter(oVar, "<this>");
        wVar.startReplaceableGroup(1206586544);
        ...
        k1.LaunchedEffect(oVar, new l(oVar, j2Var, null), wVar, i10 & 14);
        wVar.endReplaceableGroup();
        return j2Var;
    }
}
