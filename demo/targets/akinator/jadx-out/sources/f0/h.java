...
public abstract class h {
    public static final v5 collectIsFocusedAsState(o oVar, p0.w wVar, int i10) {
        e0.checkNotNullParameter(oVar, "<this>");
        wVar.startReplaceableGroup(-1805515472);
        ...
        k1.LaunchedEffect(oVar, new g(oVar, j2Var, null), wVar, i10 & 14);
        wVar.endReplaceableGroup();
        return j2Var;
    }
}
