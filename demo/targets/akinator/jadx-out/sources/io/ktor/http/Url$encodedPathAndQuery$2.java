...
public final class Url$encodedPathAndQuery$2 extends f0 implements a {
    ...
    public final String invoke() {
        int iIndexOf$default = n0.indexOf$default((CharSequence) this.this$0.urlString, '/', this.this$0.getProtocol().getName().length() + 3, false, 4, (Object) null);
