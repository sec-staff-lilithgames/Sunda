...
public final class ExceptionUtilsJvmKt$createConstructor$$inlined$safeCtor$3 extends f0 implements l {
    ...
    public final Throwable invoke(Throwable e10) {
        ...
        try {
            int i10 = z.f87419c;
            Object objNewInstance = this.$constructor$inlined.newInstance(e10.getMessage());
