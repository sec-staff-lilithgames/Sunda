...
public interface v {
    ...
    u obtainMessage(int i10);

    u obtainMessage(int i10, int i11, int i12);

    u obtainMessage(int i10, int i11, int i12, Object obj);

    u obtainMessage(int i10, Object obj);
    ...
    boolean sendMessageAtFrontOfQueue(u uVar);
}
