...
public final class y1 {
    ...
    public static final y1 f61604c;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && y1.class == obj.getClass()) {
            y1 y1Var = (y1) obj;
            if (this.f61605a == y1Var.f61605a && this.f61606b == y1Var.f61606b) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return (((int) this.f61605a) * 31) + ((int) this.f61606b);
    }
    ...
    */
    public long resolveSeekPositionUs(long r9, long r11, long r13) {
        ...
        Lf:
            ...
            r0 = r9
            long r9 = io.bidmachine.media3.common.util.a1.subtractWithOverflowDefault(r0, r2, r4)
            long r2 = r8.f61606b
            r4 = 9223372036854775807(0x7fffffffffffffff, double:NaN)
            long r2 = io.bidmachine.media3.common.util.a1.addWithOverflowDefault(r0, r2, r4)
        ...
        L52:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: io.bidmachine.media3.exoplayer.y1.resolveSeekPositionUs(long, long, long):long");
    }
}
