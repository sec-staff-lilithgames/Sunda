...
public final class e {
    ...
    public final a f66276a;

    /* renamed from: b, reason: collision with root package name */
    public final a f66277b;
    ...
    public static final class a {
        ...
        /* renamed from: a, reason: collision with root package name */
        public final b[] f66280a;

        public a(b... bVarArr) {
            this.f66280a = bVarArr;
        }

        public b getSubMesh(int i10) {
            return this.f66280a[i10];
        }

        public int getSubMeshCount() {
            return this.f66280a.length;
        }
    }
    ...
    public static final class b {
        ...
        public b(int i10, float[] fArr, float[] fArr2, int i11) {
            this.f66281a = i10;
            io.odeeo.internal.q0.a.checkArgument(((long) fArr.length) * 2 == ((long) fArr2.length) * 3);
            this.f66283c = fArr;
            this.f66284d = fArr2;
            this.f66282b = i11;
        }
    ...
    public static e createEquirectangular(int i10) {
    ...
    public e(a aVar, a aVar2, int i10) {
        ...
        this.f66277b = aVar2;
        this.f66278c = i10;
        this.f66279d = aVar == aVar2;
    }

    public static e createEquirectangular(float f10, int i10, int i11, float f11, float f12, int i12) {
        int i13;
        int i14 = i10;
        io.odeeo.internal.q0.a.checkArgument(f10 > 0.0f);
        io.odeeo.internal.q0.a.checkArgument(i14 >= 1);
        io.odeeo.internal.q0.a.checkArgument(i11 >= 1);
        io.odeeo.internal.q0.a.checkArgument(f11 > 0.0f && f11 <= 180.0f);
        io.odeeo.internal.q0.a.checkArgument(f12 > 0.0f && f12 <= 360.0f);
