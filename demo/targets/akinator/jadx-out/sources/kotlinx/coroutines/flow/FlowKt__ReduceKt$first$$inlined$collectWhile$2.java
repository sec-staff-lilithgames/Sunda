...
public final class FlowKt__ReduceKt$first$$inlined$collectWhile$2<T> implements FlowCollector<T> {
    ...
    @f(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2", f = "Reduce.kt", i = {0, 0}, l = {Sdk.SDKError.Reason.OMSDK_DOWNLOAD_JS_ERROR_VALUE}, m = "emit", n = {"this", "it"}, s = {"L$0", "L$1"})
    ...
    public FlowKt__ReduceKt$first$$inlined$collectWhile$2(p pVar, b1 b1Var) {
    ...
    */
    public java.lang.Object emit(T r5, zu.d<? super tu.x0> r6) {
        ...
        L5d:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2.emit(java.lang.Object, zu.d):java.lang.Object");
    }
}
