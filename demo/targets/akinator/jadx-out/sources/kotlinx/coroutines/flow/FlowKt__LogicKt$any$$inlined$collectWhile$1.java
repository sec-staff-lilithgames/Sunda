...
public final class FlowKt__LogicKt$any$$inlined$collectWhile$1<T> implements FlowCollector<T> {
    final /* synthetic */ w0 $found$inlined;
    final /* synthetic */ p $predicate$inlined;

    @f(c = "kotlinx.coroutines.flow.FlowKt__LogicKt$any$$inlined$collectWhile$1", f = "Logic.kt", i = {0}, l = {Sdk.SDKError.Reason.OMSDK_DOWNLOAD_JS_ERROR_VALUE}, m = "emit", n = {"this"}, s = {"L$0"})
    ...
    public FlowKt__LogicKt$any$$inlined$collectWhile$1(p pVar, w0 w0Var) {
        this.$predicate$inlined = pVar;
        this.$found$inlined = w0Var;
    }
    ...
    */
    public java.lang.Object emit(T r5, zu.d<? super tu.x0> r6) {
        ...
        L4e:
            ...
            if (r6 == 0) goto L5a
            kotlin.jvm.internal.w0 r0 = r5.$found$inlined
            r0.f71863b = r3
        L5a:
            if (r6 != 0) goto L5f
        ...
        L5f:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__LogicKt$any$$inlined$collectWhile$1.emit(java.lang.Object, zu.d):java.lang.Object");
    }
}
