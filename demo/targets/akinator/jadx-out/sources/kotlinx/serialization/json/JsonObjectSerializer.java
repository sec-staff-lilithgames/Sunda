...
public final class JsonObjectSerializer implements KSerializer<JsonObject> {
    ...
    public JsonObject deserialize(Decoder decoder) {
        ...
        return new JsonObject((Map) BuiltinSerializersKt.MapSerializer(BuiltinSerializersKt.serializer(g1.f71834a), JsonElementSerializer.INSTANCE).deserialize(decoder));
    }
    ...
    public void serialize(Encoder encoder, JsonObject value) {
        ...
        BuiltinSerializersKt.MapSerializer(BuiltinSerializersKt.serializer(g1.f71834a), JsonElementSerializer.INSTANCE).serialize(encoder, value);
    }
    ...
    public static final class JsonObjectDescriptor implements SerialDescriptor {
        ...
        private final /* synthetic */ SerialDescriptor $$delegate_0 = BuiltinSerializersKt.MapSerializer(BuiltinSerializersKt.serializer(g1.f71834a), JsonElementSerializer.INSTANCE).getDescriptor();
