...
public final class a implements z {
    ...
    public final a1 f79721a = new a1(16973, 2, "image/bmp");
    ...
    public void init(c0 c0Var) {
        this.f79721a.init(c0Var);
    }

    @Override // ko.z
    public int read(a0 a0Var, v0 v0Var) throws IOException {
        return this.f79721a.read(a0Var, v0Var);
    }

    @Override // ko.z
    public void seek(long j10, long j11) {
        this.f79721a.seek(j10, j11);
    }

    @Override // ko.z
    public boolean sniff(a0 a0Var) throws IOException {
        return this.f79721a.sniff(a0Var);
    }
