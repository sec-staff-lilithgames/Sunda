...
public final class o extends t implements Serializable {

    /* renamed from: e, reason: collision with root package name */
    public final z f91911e;

    /* renamed from: f, reason: collision with root package name */
    public final ConcurrentHashMap f91912f;

    /* renamed from: g, reason: collision with root package name */
    public final HashMap f91913g;

    /* renamed from: h, reason: collision with root package name */
    public final boolean f91914h;

    public o(z zVar, jc.o oVar, ConcurrentHashMap concurrentHashMap, HashMap map) {
        super(oVar, zVar.getTypeFactory());
        this.f91911e = zVar;
        this.f91912f = concurrentHashMap;
        this.f91913g = map;
        this.f91914h = zVar.isEnabled(y.ACCEPT_CASE_INSENSITIVE_VALUES);
    }

    public static o construct(z zVar, jc.o oVar, Collection<wc.c> collection, boolean z10, boolean z11) {
        HashMap map;
        ...
        return new o(zVar, oVar, concurrentHashMap, map);
    }
    ...
    public final String b(Class cls) {
        ...
        ConcurrentHashMap concurrentHashMap = this.f91912f;
    ...
    public String getDescForKnownTypeIds() {
        ...
        for (Map.Entry entry : this.f91913g.entrySet()) {
    ...
    public String toString() {
        return String.format("[%s; id-to-type=%s]", o.class.getName(), this.f91913g);
    }
    ...
    public jc.o typeFromId(jc.h hVar, String str) {
        ...
        return (jc.o) this.f91913g.get(str);
    }
}
