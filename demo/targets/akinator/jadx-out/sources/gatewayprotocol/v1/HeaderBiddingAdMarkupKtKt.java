...
public final class HeaderBiddingAdMarkupKtKt {
    ...
    public static final HeaderBiddingAdMarkupOuterClass.HeaderBiddingAdMarkup m4081initializeheaderBiddingAdMarkup(kv.l block) {
    ...
    public static final HeaderBiddingAdMarkupOuterClass.HeaderBiddingAdMarkup copy(HeaderBiddingAdMarkupOuterClass.HeaderBiddingAdMarkup headerBiddingAdMarkup, kv.l block) {
        kotlin.jvm.internal.e0.checkNotNullParameter(headerBiddingAdMarkup, "<this>");
        kotlin.jvm.internal.e0.checkNotNullParameter(block, "block");
        HeaderBiddingAdMarkupKt.Dsl.Companion companion = HeaderBiddingAdMarkupKt.Dsl.Companion;
