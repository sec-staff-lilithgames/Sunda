...
public final class w implements Internal.ListAdapter.Converter {
    ...
    public DiagnosticEventRequestOuterClass.DiagnosticTagType convert(Integer num) {
        DiagnosticEventRequestOuterClass.DiagnosticTagType diagnosticTagTypeForNumber = DiagnosticEventRequestOuterClass.DiagnosticTagType.forNumber(num.intValue());
