...
public final class o extends bv.n implements kv.p {
    ...
    public final /* synthetic */ q f77354j;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o(q qVar, zu.d dVar) {
        super(2, dVar);
        this.f77354j = qVar;
    }
    ...
    public final zu.d<x0> create(Object obj, zu.d<?> dVar) {
        return new o(this.f77354j, dVar);
    }

    @Override // bv.a
    public final Object invokeSuspend(Object obj) {
        Object coroutine_suspended = av.e.getCOROUTINE_SUSPENDED();
        int i10 = this.f77353i;
        if (i10 == 0) {
            tu.a0.throwOnFailure(obj);
            c0.e eVar = this.f77354j.f77363g;
            Float fBoxFloat = bv.b.boxFloat(0.0f);
            m2 m2VarTween$default = c0.o.tween$default(150, 0, i0.getLinearEasing(), 2, null);
            this.f77353i = 1;
