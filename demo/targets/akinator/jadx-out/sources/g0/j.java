...
public final class j implements h {
    ...
    public final float f56489a = s2.i.m6817constructorimpl(0);
    ...
    public void arrange(s2.e eVar, int i10, int[] sizes, s2.x layoutDirection, int[] outPositions) {
        ...
        if (layoutDirection == s2.x.f85363b) {
            u.f56588a.placeSpaceBetween$foundation_layout_release(i10, sizes, outPositions, false);
        } else {
            u.f56588a.placeSpaceBetween$foundation_layout_release(i10, sizes, outPositions, true);
        }
    }
