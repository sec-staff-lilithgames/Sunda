...
public final class m implements g {
    ...
    public void arrange(s2.e eVar, int i10, int[] sizes, s2.x layoutDirection, int[] outPositions) {
        ...
        if (layoutDirection == s2.x.f85363b) {
            u.f56588a.placeLeftOrTop$foundation_layout_release(sizes, outPositions, false);
        } else {
            u.f56588a.placeRightOrBottom$foundation_layout_release(i10, sizes, outPositions, true);
        }
    }
