...
public final class f implements g {
    ...
    public void arrange(s2.e eVar, int i10, int[] sizes, s2.x layoutDirection, int[] outPositions) {
        ...
        if (layoutDirection == s2.x.f85363b) {
            u.f56588a.placeRightOrBottom$foundation_layout_release(i10, sizes, outPositions, false);
        } else {
            u.f56588a.placeLeftOrTop$foundation_layout_release(sizes, outPositions, true);
        }
    }

    @Override // g0.g, g0.o
    /* renamed from: getSpacing-D9Ej5fM */
    public /* bridge */ /* synthetic */ float mo3858getSpacingD9Ej5fM() {
        return super.mo3858getSpacingD9Ej5fM();
    }
