...
public final class g0 extends kotlin.jvm.internal.f0 implements kv.s {

    /* renamed from: e, reason: collision with root package name */
    public static final g0 f56428e = new g0(5);
    ...
    public final void invoke(int i10, int[] size, s2.x xVar, s2.e density, int[] outPosition) {
        ...
        u.f56588a.getTop().arrange(density, i10, size, outPosition);
    }
}
