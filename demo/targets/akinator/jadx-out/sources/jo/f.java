...
public final class f {
    ...
    public final a f69827a;

    /* renamed from: b, reason: collision with root package name */
    public final a f69828b;

    /* renamed from: c, reason: collision with root package name */
    public final int f69829c;

    /* renamed from: d, reason: collision with root package name */
    public final boolean f69830d;

    /* compiled from: r8-map-id-329fa88356c9e071bedcd87e8cbc16a4cb0c028932e63902b8210957806638ae */
    public static final class a {

        /* renamed from: a, reason: collision with root package name */
        public final b[] f69831a;

        public a(b... bVarArr) {
            this.f69831a = bVarArr;
        }

        public b getSubMesh(int i10) {
            return this.f69831a[i10];
        }

        public int getSubMeshCount() {
            return this.f69831a.length;
        }
    }
    ...
    public static final class b {
        ...
        public b(int i10, float[] fArr, float[] fArr2, int i11) {
            this.f69832a = i10;
            io.bidmachine.media3.common.util.a.checkArgument(((long) fArr.length) * 2 == ((long) fArr2.length) * 3);
            this.f69834c = fArr;
            this.f69835d = fArr2;
            this.f69833b = i11;
        }
    ...
    public static f createEquirectangular(float f10, int i10, int i11, float f11, float f12, int i12) {
        ...
        io.bidmachine.media3.common.util.a.checkArgument(i14 >= 1);
        io.bidmachine.media3.common.util.a.checkArgument(i11 >= 1);
        io.bidmachine.media3.common.util.a.checkArgument(f11 > 0.0f && f11 <= 180.0f);
        io.bidmachine.media3.common.util.a.checkArgument(f12 > 0.0f && f12 <= 360.0f);
