...
public class b extends fm.a {
    public b() {
        super(19, new vr.a(22, 0, 0));
    }

    @Override // fm.a, fm.b
    public u createAd(j0 j0Var, l0 l0Var, AdsFormat adsFormat, Waterfall.Configuration.AdUnit adUnit, w wVar) {
        switch (a.f59002a[adsFormat.ordinal()]) {
            case 1:
            case 2:
                return new e(j0Var, l0Var, adsFormat, adUnit, wVar, AdSize.BANNER);
            case 3:
                return new e(j0Var, l0Var, adsFormat, adUnit, wVar, AdSize.LEADERBOARD);
            case 4:
                return new e(j0Var, l0Var, adsFormat, adUnit, wVar, AdSize.MEDIUM_RECTANGLE);
            case 5:
            case 6:
            case 7:
                return new i(j0Var, l0Var, adsFormat, adUnit, wVar);
            case 8:
            case 9:
            case 10:
                return new m(j0Var, l0Var, adsFormat, adUnit, wVar);
            default:
                return null;
        }
    }
