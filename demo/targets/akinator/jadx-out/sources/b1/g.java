...
public final class g extends m {
    ...
    public final kv.l f8612f;

    /* renamed from: g, reason: collision with root package name */
    public final m f8613g;

    public g(long j10, u uVar, kv.l lVar, m mVar) {
        super(j10, uVar, (kotlin.jvm.internal.u) null);
        this.f8612f = lVar;
        this.f8613g = mVar;
        mVar.mo110nestedActivated$runtime(this);
    }
    ...
    public void dispose() {
        ...
        m mVar = this.f8613g;
        if (snapshotId != mVar.getSnapshotId()) {
            closeAndReleasePinning$runtime();
        }
        mVar.mo111nestedDeactivated$runtime(this);
        super.dispose();
    ...
    @Override // b1.m
    public g takeNestedSnapshot(kv.l lVar) {
        ...
        g gVar = new g(getSnapshotId(), getInvalid$runtime(), y.c(lVar, getReadObserver()), getParent());
        if (jVar != null) {
