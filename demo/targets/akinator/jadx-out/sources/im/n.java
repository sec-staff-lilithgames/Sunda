...
public final class n extends h0 {
    ...
    public RewardedAd f59751k;

    @Override // em.u
    public final void b() {
        RewardedAd rewardedAd = this.f59751k;
        if (rewardedAd != null) {
            rewardedAd.setFullScreenContentCallback(null);
            this.f59751k.setOnPaidEventListener(null);
            this.f59751k = null;
        }
    }
    ...
    public final void d(Activity activity, d0 d0Var) {
        ...
        if (rewardedAd != null) {
            ...
            this.f59751k.show(activity, new m());
        } else {
    ...
    public final void loadAd(Context context, g0 g0Var) {
        RewardedAd.load(context, getAdUnitId(), o.a(getAdUnit()), (RewardedAdLoadCallback) new j(this, g0Var));
    }
}
