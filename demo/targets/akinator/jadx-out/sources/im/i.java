...
public final class i extends e0 {
    ...
    public AdManagerInterstitialAd f59744k;

    @Override // em.u
    public final void b() {
        AdManagerInterstitialAd adManagerInterstitialAd = this.f59744k;
        if (adManagerInterstitialAd != null) {
            adManagerInterstitialAd.setFullScreenContentCallback(null);
            this.f59744k.setOnPaidEventListener(null);
            this.f59744k = null;
        }
    }
    ...
    public final void loadAd(Context context, g0 g0Var) {
        AdManagerInterstitialAd.load(context, getAdUnitId(), o.a(getAdUnit()), new g(this, g0Var));
    }
}
