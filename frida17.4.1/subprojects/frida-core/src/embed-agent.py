...
def main(argv):
    ...
    if host_os == "windows":
        ...
        for agent in {agent_modern, agent_legacy, agent_emulated_modern, agent_emulated_legacy}:
            ...
            # Sunda fingerprint hardening: avoid stock Frida agent asset names.
            embedded_agent = priv_dir / f"sunda-agent-{arch}.dll"
        ...
        for missing_arch in pending_archs:
            embedded_agent = priv_dir / f"sunda-agent-{missing_arch}.dll"
        ...
        embedded_agent = priv_dir / "sunda-agent.dylib"
        ...
        embedded_agent = priv_dir / "sunda-agent.so"
