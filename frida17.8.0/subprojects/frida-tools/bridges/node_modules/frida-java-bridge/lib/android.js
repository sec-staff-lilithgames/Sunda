  ...
  vm.perform(env => {
    ...
    try {
      ...
      if (offsetCopiedMethods === -1) {
         ...
         * model now derives the actual method count from the methods_ array
         * header, so we only keep a stable placeholder offset here for
         * structure packing instead of aborting bridge initialization.
         */
